...
<!--極度種類,手形貸付関連口座-->
<label class="tab_page_label" style="width:119px;"><script>w1('LIMITKIND')</script></label>
<select name='f27' table='LNPCODE' key='632' style='width:266px;' onChange='u_limitLon();'></select>
<label class="tab_page_label" style="margin-left:12px;"><script>w1('ACCTABOUTBILLLOAN')</script></label>
<input name='f45_1' type='hidden'><input name='f45_2' type='hidden'><input name='f45_3' style='width:44px;' disabled='true'><input name='f45_4' style='width:24px;' disabled='true'><input name='f45_5' style='width:74px;' disabled='true'><br>

<!--勘定別コード,資金別コード-->
<label class="tab_page_label"><script>w1('GLCD')</script></label>
<input name='f30' style='width:29px;' qtype="3001" slave="f31" onblur='u_paddind(this.value);u_limitLon();selectGrp();'><input name='f30Lbl' size ='45' style="width:356px;" readonly tabIndex='-1'>
<label class="tab_page_label"><script>w1('FUNDTYPCD')</script></label>
<input name='f31' style='width:29px;' qtype="3002" master="f30" slave="f32" onblur='u_paddind(this.value);u_limitLon();selectGrp();'><input name='f31Lbl' size ='47' style="width:370px;" readonly tabIndex='-1'><br>

<!--勘定科目コード,小科目コード-->
<label class="tab_page_label"><script>w1('GLGRPCD')</script></label>
<input name='f32' style='width:34px;' qtype="3003" master="f31" master2="f30" slave="f33" onblur='u_paddind(this.value);u_limitLon();selectGrp();'><input name='f32Lbl' style='width:351px;' size='44' readonly tabIndex='-1'>
<label class="tab_page_label"><script>w1('SUBGRPCD')</script></label>
<input name='f33' style='width:44px;' qtype="3004" master="f32" master2="f31" master3="f30" slave="f34" onblur='checkf33();doCheckBoxYN_2();u_paddind(this.value);u_limitLon();selectGrp();' ><input name='f33Lbl' style='width:355px;' size ='44' readonly tabIndex='-1'><br>

<!--資金使途,実行予定日-->
<div class="container">
	<label class="tab_page_label"><script>w1('FUNDUSECD')</script></label>
	<input name='f34' style='width:44px;' qtype="3005" master="f33" master2="f32" master3="f31" master4="f30" onblur='u_paddind(this.value)'><input name='f34Lbl' style='width:341px;' size ='42' readonly tabIndex='-1'>

	<label class="tab_page_label"><script>w1('LONREQDT')</script></label>
	<input name='f35_1' style='width:44px;' onblur="checkf33();u_limitLon();selectGrp();"><input name='f35_2' style='width:29px;' onblur="checkf33();u_limitLon();selectGrp();"><input name='f35_3' style='width:29px;' onblur="checkf33();doCheckBoxYN_2();u_limitLon();selectGrp();">

    <a href="#" id="openCalendar" class="calendar-icon"></a>
...
<label class="tab_page_label" style='margin-left:73px;'><script>w1('OUTCOLLTYP')</script></label>
...
<input name='f36' style='width:154px;'>
...
<input name='f43_1' style='width:19px;' qtype='3011' slave="f43" data-methods="getDesc();dambokind();autoinit()" onkeyup="autoinit()" onkeydown="allowNumber()" maxlength=1><input name='f43_1Lbl' style='width:204px;' readonly tabindex='-1'><input name='f43' style='width:34px;' qtype='3012' master='f43_1' data-methods="getDesc()" onkeyup="autoinit()" onkeydown="allowNumber()" maxlength=3><input name='f43Lbl' style='width:204px;' readonly tabindex='-1'><br>

<label class="tab_page_label"><script>w1('GUARNTCNT')</script></label>
<input name='f41' style='width:24px;' onkeyup='u_zeroCheck(this.name)'><br>

<label class="tab_page_label"><script>w1('PERUNDERCHAR')</script></label>
<input name='f37' style='width:84px;' qtype='28'><input name='f37Lbl' style='width:324px;' readonly tabindex='-1'>
...
<input name='f46' style='width:404px;' maxlength='30'><br>
...
<input name='f904_1' type='hidden'><input name='f904_2' style='width:44px;'><input name='f904_3' style='width:44px;'><input name='f904_4' style='width:24px;'><input name='f904_5' style='width:54px;'>
<label class="tab_page_label" style='margin-left:116px;'><script>w1('LOANTOTAMT')</script></label>
<input name='f905' style='width:154px;'><br>

<label class="tab_page_label"><script>w1('INFOBRN')</script></label>
<input name='f901' style='width:44px;' qtype='14'><input name='f901Lbl' style='width:204px;' readonly tabindex='-1'>
<label class="tab_page_label" style='margin-left:34px;'><script>w1('TRBRANCH')</script></label>
<input name='f902' style='width:44px;' qtype='14''><input name='f902Lbl' style='width:204px;' readonly tabindex='-1'><br>

<label class="tab_page_label"><script>w1('EMPBRN')</script></label>
<input name='f903' style='width:44px;' qtype='14'><input name='f903Lbl' style='width:204px;' readonly tabindex='-1'><br>
</div>
