...
<input type=hidden name='f1' style='width:84px;'><br>
<!--
<label class="tab_page_label"><script>w1('CNSLNO')</script></label>
<input name='f2_1' style='width:84px;' type=hidden><input name='f2_2' style='width:44px;' readonly tabindex='-1'><input name='f2_3' style='width:44px;' readonly tabindex='-1'><input name='f2_4' style='width:24px;' readonly tabindex='-1'><input name='f2_5' style='width:54px;' readonly tabindex='-1'>
<label class="tab_page_label"><script>w1('LONSTATUS')</script></label>
<input name='p1' style='width:84px' readonly tabindex='-1'><br> -->

<!--<label class="tab_page_label"><script>w1('TYPE')</script></label>-->
<input type=hidden name='f3' style='width:84px;'><input type=hidden name='f4' style='width:154px;'>
<!--<label class="tab_page_label"><script>w1('BISID')</script></label>-->
<input type=hidden name='f5' style='width:154px;'>
<label class="tab_page_label"><script>w1('CIF')</script></label>
<input type=hidden name='f6_1' style='width:84px;'><input type=hidden name='f6_2' style='width:84px;'><input name='f6_3' style='width:84px;'><input type=hidden name='p2' style='width:154px;' readonly tabindex='-1'><br>
</p>