...
<input name='p21' style='width:721px;' readonly tabindex='-1'><br>
...
<input name='p24' style='width:721px;' readonly tabindex='-1'><br>
</p>
...
<input name='f30' style='width:29px;' qtype="3001" slave="f31" onblur='u_paddind(this.value);u_limitLon();selectGrp();'><input name='f30Lbl' size ='45' readonly tabIndex='-1'>
<label class="tab_page_label"><script>w1('FUNDTYPCD')</script></label>
<input name='f31' style='width:29px;' qtype="3002" master="f30" slave="f32" onblur='u_paddind(this.value);u_limitLon();selectGrp();'><input name='f31Lbl' size ='47' readonly tabIndex='-1'><br>
...
<input name='f35_1' style='width:44px;' onblur="checkf33();u_limitLon();selectGrp();"><input name='f35_2' style='width:29px;' onblur="checkf33();u_limitLon();selectGrp();"><input name='f35_3' style='width:29px;' onblur="checkf33();doCheckBoxYN_2();u_limitLon();selectGrp();"><br>
