...
<!-- START OF 05.JSP -->
	...
	/* Screen initial anger control */
		...
		if (objAll.f29.value == "2" || objAll.f29.value == "4") {
			lastFocusField = document.all.f41;
		}else{
			lastFocusField = document.all.f29;
		}
		tabItemSelect(2);
...
//			alert("document53= "+ document.all.f53.value);
		}else{
			document.all.f53.checked = false;
			document.all.f53.value = 'n';
		}
		
		if(document.all.f53.disabled==true || document.all.f53.checked==false) {
		...
		set("f51","f58");		
		document.all.f51.value=(parseInt(document.all.f51.value,10)==0)?"":padNumber(document.all.f51.value,4);
	...
	/* Financing consultation result */
		if( parseInt(getOutput("f500"),10) == 7 || parseInt(getOutput("f500"),10) == 8 ) {
			...
			document.all.f51.disabled = true;
			document.all.f51Lbl.disabled = true;
			...
			document.all.f902.disabled = true;
			document.all.f902Lbl.disabled = true;			
		}
...
//		alert(obj.value);
	...
	function checkf33() {
		...
		***********************************/		
	    ...
	    if (flagGUAR_COMP == "1") {	/*  Guarantee association end cord*/
		...
		/* Group flag 1,2,3*/
//		alert("flagGROUP_LIFE=" +flagGROUP_LIFE);
	...
	function joinType() {
		document.all.sample.style.width=340;
		lastFocusField=document.all.f914;
	...
	function Localquery2(){
		if(document.all.f51.value != "" && dataForm.action!=top.CONTEXT+"/4.LON/12010/process2.jsp"){
...
<input name='f7' style='width:150' readonly tabindex='-1'>
...
<label class="tab_page_label" style='margin-left:-46'><script>w1('COMSCALE')</script></label>
...
<select name='f27' table='LNPCODE' key='632' style='width:266px;' onblur='u_limitLon()'></select>
...
<input name='f43_1' style='width:15px;' qtype='3011' slave='f43' onpropertychange="getDesc();dambokind();autoinit()" onkeyup="autoinit()" onkeydown="allowNumber()" maxlength='1'><input name='f43_1Lbl' style='width:200' readonly tabindex='-1'><input name='f43' style='width:30' qtype='3012' master='f43_1' onpropertychange="getDesc()" onkeyup="autoinit()" onkeydown="allowNumber()" maxlength='3'><input name='f43Lbl' style='width:200' readonly tabindex='-1'><br>
...
<input name='f37' style='width:80px;' qtype='28' readonly tabindex='-1' pop='no'><input name='f37Lbl' style='width:320' readonly tabindex='-1'>
...
<input name='f902' style='width:40px;' qtype='14' readonly tabindex='-1' pop='no'><input name='f902Lbl' style='width:200px;' readonly tabindex='-1'><br>
...
<input name='f51' style='width:40px;' qtype='3133' master='glDay' onpropertychange="Localquery2()" readonly tabindex='-1' pop='no'><input name='f51Lbl' style='width:230px;' readonly tabindex='-1'>
...
<input name='f53' type='checkbox' style="margin-left:-4px;" >&nbsp;<script>w1('CKECKYN')</script>
<label class="tab_page_label" style='margin-left:180px;'><script>w1('LOANINSLNO')</script></label>
<!--<input name='f54' style='width:170px;' maxlength='20' readonly tabindex='-1'><br>-->
...
<label class="tab_page_label" style='margin-left:180' id='sample'><script>w1('JOINDEBTRATE')</script></label>
<input name='p906' style='width:30;text-align:right;' readonly tabIndex='-1'>%<br>
