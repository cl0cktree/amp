...
%>
    ...
    */
	...
	function getCaptPayBackCycl(){
		...
		*/
		var node_root = "/table/record[@CODE_KIND = 505 and @CODE_5="+
                <%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[114]) %>+
                " and @CODE_5 > 0 and (@STA=1 or @STA=2)]";
...
/*	function getCaptPayBackCycl(){
	...
	function getIntpayBackCycl(){
		...
		*/
		...
		var node_root = "/table/record[@CODE_KIND = 504 and @CODE_5="+
		        <%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[115]) %>+
                " and @CODE_5 > 0 and (@STA=1 or @STA=2)]";
		var node_xpath = document.evaluate(node_root, top.LNPCODE, null, XPathResult.FIRST_ORDERED_NODE_TYPE, null);	
		node = node_xpath.singleNodeValue;
...
<tr>
	...
	<td><input name='f4' style='width:119px;' value="<%= XmlUtil.dataPattern("a",xp.xpd.node_value[startpoint++],0) %>"></td>
	<!--予約取引追加-->
    <td><label style='display:inline-block;width:60px'>予約取引</label></td>
	<td><input name='f801' style='width:134px;' readonly tabindex='-1' value="<%= xp.xpd.node_value[307] %>"></td>
	<td><label style='display:inline-block;width:60px'>相談番号</label></td>
	<td><input name='f5' style='width:144px;' value="<%= XmlUtil.dataPattern("c",xp.xpd.node_value[startpoint++],0) %>"></td>
	<td><label style='display:inline-block;width:70px;'>状態コード</label></td>
	<td><input name='f6' style='width:29px;' value="<%= xp.xpd.node_value[startpoint++] %>"><input name='f7' style='width:calc(100% - 37px); min-width:104px;' value="<%= xp.xpd.node_value[startpoint++] %>"></td>
</tr>
<tr>
	<td><label style='display:inline-block;width:90px'>管理店番</label></td>
	<td colspan='3' ><input name='f8' style='width:44px' value="<%= xp.xpd.node_value[startpoint++] %>"><input name='f9' style='width: calc(100% - 63px); min-width:274px;' value="<%= xp.xpd.node_value[startpoint++] %>"></td>
	<td style='margin-left:25px'><label style='display:inline-block;width:60px;'>情報店</label></td>
	<td colspan='3'><input name='f10' style='width:44px' value="<%= xp.xpd.node_value[startpoint++].trim() %>"><input name='f11' style='width: calc(100% - 52px); min-width:304px;' value="<%= xp.xpd.node_value[startpoint++] %>"></td>
</tr>
<tr>
	<td><label style='display:inline-block;width:90px'>商品コード</label></td>


	<td colspan='6'><input name='f12' style='width:104px' value="<%= XmlUtil.dataPattern("p",xp.xpd.node_value[startpoint++],0) %>"><input name='f13' style='width:484px' value="<%= xp.xpd.node_value[startpoint++] %>"></td>
...
<tr>
	...
	<td colspan='3'><input name='f14' style='width:84px;' value="<%= XmlUtil.dataPattern("f",xp.xpd.node_value[24],10) %>"><!--顧客名（カナ）--><input name='f15' style='width:632px;' value="<%= xp.xpd.node_value[25] %>"></td>
</tr>
<tr>
	<td nowrap>&nbsp;</td>
	<td colspan='3'><!--顧客名（漢字）--><input name='f500' style='margin-left:84px; width:632px' readonly tabindex='-1' value="<%= xp.xpd.node_value[26].trim() %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">生年月日</label></td>
	<td><input name='f16' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[27]) %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">職業コード</label></td>
	<td><input name='f17' style='width:44px;' value="<%= xp.xpd.node_value[28].trim() %>"><input name='f18' style='width:219px;' value="<%= xp.xpd.node_value[29].trim() %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">業種コード</label></td>
	<td><input name='f293' style='width:84px;' value="<%= xp.xpd.node_value[31].trim() %>" readonly tabindex='-1'><input name='f294' style='width:244px;' value="<%= xp.xpd.node_value[32].trim() %>" readonly tabindex='-1'></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">企業体規模</label></td>
	<td><input name='f19' style='width:154px;' value="<%= xp.xpd.node_value[30].trim() %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">住所</label></td>
	<td colspan='3'><input name='f20' style='width:84px;' value="<%= XmlUtil.dataPattern("z",xp.xpd.node_value[33],0) %>"><input name='f21' style='width:632px;' value="<%= xp.xpd.node_value[34].trim() %>"></td>
</tr>
<tr>
	<td>&nbsp;</td>
<%
...
%>
	<td colspan='3'><input name='f521' style='width:716px;' value="<%= xp.xpd.node_value[35].trim() %>" readonly tabindex='-1'></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">電話番号</label></td>
	<td><input name='f22' style='width:114px;' value="<%= xp.xpd.node_value[36].trim() %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">取引中止</label></td>
	<td><input name='f25' style='width:29px;' value="<%= xp.xpd.node_value[41] %>"><input name='f26' style='width:234px;' value="<%= xp.xpd.node_value[42] %>"></td>
</tr>
<tr>
...
%>
	<td><input name='f23' style='width:154px;' value="<%= f23 %>"><input type='hidden' name="f296" style='width:204px;' value="<%= xp.xpd.node_value[38] %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">引落口座番号</label></td>
	<td><input name='f24' style='width:154px;' readonly value="<%= XmlUtil.dataPattern("a2",xp.xpd.node_value[39],0) %>"></td>
</tr>
...
<tr>
	...
	<td><input name='f700' style='width:154px;' readonly value="<%= XmlUtil.dataPattern("a2",xp.xpd.node_value[40],0) %>" type='hidden'></td>
</tr>
<!-- ↑↑↑ 2018/12/05 EK END ↑↑↑ -->
...
%>
	<td><input name='f501' style='width:84px' value="<%= f501 %>" readonly tabindex='-1'></td>
...
<tr id=regInfo1>
	...
	<td colspan='3'><input name='f901' style='width:44px;'  value="<%= xp.xpd.node_value[320] %>" readonly tabindex='-1'><input name='f902' style='width:404px;' value="<%=  xp.xpd.node_value[321]%>" readonly tabindex='-1' type=text></td>
</tr>
<tr id="regInfo2" >
	<td nowrap style='text-align:right;'><label></label></td>
	<td colspan='3'><input name='f903' style='width:44px;'  value="<%= xp.xpd.node_value[322] %>" readonly tabindex='-1'><input name='f904' style='width:404px;' value="<%=  xp.xpd.node_value[323]%>" readonly tabindex='-1' type=text></td>
</tr>
<tr id="regInfo3" >
	<td nowrap style='text-align:right;'><label></label></td>
...
<tr>
	...
	<td><input name='f27' style='width:134px;' value="<%= xp.xpd.node_value[startpoint++].trim() %>"></td>
	<td nowrap style='text-align:right;'><label>新規区分</label></td>
	<td><input name='f28' style='width:134px;' value="<%= xp.xpd.node_value[startpoint++].trim() %>"></td>
	<td nowrap style='text-align:right;'><label>貸出実行方法</label></td>
	<td><input name='f29' style='width:134px;' value="<%= xp.xpd.node_value[startpoint++].trim() %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label>稟議区分</label></td>
	<td><input name='f30' style='width:134px;' value="<%= xp.xpd.node_value[startpoint++].trim() %>"></td>
	<td nowrap style='text-align:right;'><label>限度区分</label></td>
	<td><input name='f31' style='width:134px;' value="<%= xp.xpd.node_value[startpoint++].trim() %>"></td>
	<td nowrap style='text-align:right;'><label>完済区分</label></td>
	<td><select name='f310' style='width:134px;' table='LNPCODE' key='740' disabled=true></select></td> <!-- XmlUtil.nNullCheck(xp.xpd.node_value[startpoint++]) !-->
</tr>
<%
					startpoint++; // f32;
%>
<tr>
	...
	<!-- ↑↑↑ 2018/09/28 EK 尹 END ↑↑↑ -->
	<td><input name='f32' style='width:134px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[startpoint++] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>実行金額</label></td>

	<td><input name='f33' style='width:134px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[startpoint++] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>現在残高</label></td>

	<td><input name='f34' style='width:134px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[startpoint++] ,xp.oheader.node_value[35]) %>"></td>
...
<tr>
    ...
    <td><input name='f316' style='width:134px;' value="<%= xp.xpd.node_value[316].trim() %>" readonly tabindex='-1'></td>
	<td nowrap style='text-align:right;'><label>ボーナス分金額</label></td>

	<td><input name='f307' style='width:134px;text-align:right' value="<%= makemask7("17.2" ,xp.xpd.node_value[94] ,xp.oheader.node_value[35]) %>" readonly tabindex='-1'></td>

	<td nowrap style='text-align:right;'><label>ボーナス残高</label></td>

	<td><input name='f503' style='width:134px;text-align:right' value="<%= makemask7("17.2" ,xp.xpd.node_value[f503] ,xp.oheader.node_value[35]) %>" readonly tabindex='-1'></td>


</tr>
<tr>
	<td nowrap style='text-align:right;'><label>資金使途</label></td>
	<td colspan='5'><input name='f35' style='width:44px;' value="<%= xp.xpd.node_value[startpoint++] %>"><input name='f36' style='width:394px;' value="<%= xp.xpd.node_value[startpoint++].trim() %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label>勘定コード(B/S)</label></td>
	<td colspan='5'><input name='f37' style='width:84px;' value="<%= xp.xpd.node_value[startpoint++] %>"><input name='f38' style='width:354px;' value="<%= xp.xpd.node_value[startpoint++].trim() %>">
	<!--自動振替区分--><input type='hidden' name='f39' style='width:84px;' value="<%= xp.xpd.node_value[startpoint++].trim() %>"></td>
</tr>
    <!--専決権者コード--><input type='hidden' name='f40' style='width:154px;' value="<%= xp.xpd.node_value[startpoint++] %>">
    <!--担保種類--><!--<input name='f41' style='width:84px'></td>-->
<tr>
	<td nowrap style='text-align:right;'><label>担当者番号</label></td>
	<td colspan='5'><input name='f41' style='width:94px;' value="<%= xp.xpd.node_value[startpoint] %>"><input name='f41Lbl' style='width:214px;' readonly tabindex='-1'>
	<script>
...
<tr>
	...
	<td nowrap colspan='5'><input name='f42' style='width:94px;' value="<%= xp.xpd.node_value[startpoint] %>"><input name='f42Lbl' style='width:214px;' readonly tabindex='-1'>
	<script>
		var code = '<%= xp.xpd.node_value[startpoint++] %>';
		if(code !='9999999999'){
			/*//origin
	...
	<label class="tab_page_label" style='width:70px'>承認権者</label>
	<input name='f43' style='width:94px;' value="<%= xp.xpd.node_value[startpoint] %>" readonly><input name='f43Lbl' style='width:204px;' readonly tabindex='-1'>
	<script>
		var code = '<%= xp.xpd.node_value[startpoint++] %>';
		if(code !='9999999999'){
			/* //origin
...
<tr>
	...
	<td><input name='f44' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
	<td nowrap style='text-align:right;'><label>実行日</label></td>
	<td><input name='f45' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
	<td nowrap style='text-align:right;'><label>承認期限</label></td>
	<td><input name='f46' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label>最終元金返済日</label></td>
	<td><input name='f47' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
	<td nowrap style='text-align:right;'><label>最終利息返済日</label></td>
	<td><input name='f48' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
	<td nowrap style='text-align:right;'><label>据置終了日</label></td>
	<td><input name='f49' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label>最終取引日</label></td>
	<td><input name='f50' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
	<td nowrap style='text-align:right;'><label>ボーナス返済月1</label></td>
	<td><input name='f51' style='width:29px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[startpoint++]) %>"></td>
	<td nowrap style='text-align:right;'><label>ボーナス返済月2</label></td>
	<td><input name='f52' style='width:29px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[startpoint++]) %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label>毎回分約定期限</label></td>
	<td><input name='f53' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
	<td nowrap style='text-align:right;'><label>ボーナス分約定期限</label></td>
	<td><input name='f54' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
	<td nowrap style='text-align:right;'><label>ボーナス分利済日</label></td>
	<td><input name='f55' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label>利済日</label></td>
	<td><input name='f56' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[startpoint++]) %>"></td>
	<td nowrap style='text-align:right;'><label>初回分割金</label></td>


	<td><input name='f57' style='width:134px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[startpoint++] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>毎回分割金</label></td>

	<td><input name='f58' style='width:134px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[startpoint++] ,xp.oheader.node_value[35]) %>"></td>

</tr>
<tr>
	<td nowrap style='text-align:right;'><label>最終分割金</label></td>

	<td><input name='f59' style='width:134px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[startpoint++] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>ボーナス分初回分割金</label></td>

	<td><input name='f60' style='width:134px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[startpoint++] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>ボーナス分毎回分割金</label></td>

	<td><input name='f61' style='width:134px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[startpoint++] ,xp.oheader.node_value[35]) %>"></td>

</tr>
<tr>
	<td nowrap style='text-align:right;'><label>ボーナス分最終回分割金</label></td>

	<td colspan='5'><input name='f62' style='width:134px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[startpoint++] ,xp.oheader.node_value[35]) %>"></td>
...
<tr>
	...
	<td><input name='f63'  style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[95] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>経過利息</label></td>

	<td><input name='f600' style='width:134px;text-align:right' value="<%= makemask7("14.2" ,xp.xpd.node_value[299] ,xp.oheader.node_value[35]) %>" readonly tabindex='-1'></td>

	<td nowrap style='text-align:right'><label>延滞利息</label></td>

	<td><input name='f64'  style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[96] ,xp.oheader.node_value[35]) %>"></td>

</tr>
<tr>
	<td nowrap style='text-align:right;'><label>毎回分約定未収利息</label></td>

	<td><input name='f66' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[98] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>未経過利息</label></td>

	<td><input name='f603' style='width:134px;text-align:right' value="<%= makemask7("14.2" ,xp.xpd.node_value[317] ,xp.oheader.node_value[35]) %>" readonly tabindex='-1' ></td>

	<td nowrap style='text-align:right'><label>未払利息</label></td>

	<td><input name='f67' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[99] ,xp.oheader.node_value[35]) %>"></td>

</tr>
<tr>
	<td nowrap style='text-align:right;'><label>未収利息</label></td>

	<td><input name='f65' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[97] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right'><label>減免約定利息</label></td>

	<td><input name='f73' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[105] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>減免延滞利息</label></td>

	<td><input name='f74' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[106] ,xp.oheader.node_value[35]) %>"></td>
...
<tr>
	...
	<td><input name='f68'  style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[100] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>ボーナス分経過利息</label></td>

	<td><input name='f601' style='width:134px;text-align:right' value="<%= makemask7("14.2" ,xp.xpd.node_value[300] ,xp.oheader.node_value[35]) %>" readonly tabindex='-1' ></td>

	<td nowrap style='text-align:right;'><label>ボーナス分延滞利息</label></td>

	<td><input name='f69'  style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[101] ,xp.oheader.node_value[35]) %>"></td>

</tr>
<tr>
	<td nowrap style='text-align:right;'><label>ボーナス分約定未収利息</label></td>

	<td><input name='f71' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[103] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>ボーナス分未経過利息</label></td>

	<td><input name='f604' style='width:134px;text-align:right' value="<%= makemask7("14.2" ,xp.xpd.node_value[318] ,xp.oheader.node_value[35]) %>" readonly tabindex='-1' ></td><!--Last Num-->

	<td nowrap style='text-align:right;'><label>ボーナス分未払利息</label></td>

	<td><input name='f72'  style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[104] ,xp.oheader.node_value[35]) %>"></td>

</tr>
<tr>
	<td nowrap style='text-align:right'><label>ボーナス分未収利息</label></td>

	<td><input name='f70'  style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[102] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right'><label>ボーナス分減免延滞利息</label></td>

	<td><input name='f76' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[108] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label>ボーナス分減免約定利息</label></td>

	<td><input name='f75' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[107] ,xp.oheader.node_value[35]) %>"></td>
...
<input name='f78_1' style='width:44px;' value="<%= XmlUtil.nNullCheck(xp.xpd.node_value[110]) %>" readonly tabindex='-1'><input name='f410' style='width:274px;'  value="<%= xp.xpd.node_value[111] %>" readonly tabindex='-1'><br>
...
<label class="tab_page_label" style='margin-left:-23px'>利息返済方式</label>
...
<input name='f79' style='width:29px;' qtype='3110' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[114]) %>"><input name='f79Lbl' style='width:122px;' readonly tabindex='-1'>
<label class="tab_page_label" style='margin-left:-18px'>利息返済周期</label>
<input name='f80' style='width:29px;' qtype='3110' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[115]) %>"><input name='f80Lbl' style='width:122px;' readonly tabindex='-1'><br>
...
<label class="tab_page_label" style='margin-left:69px;'>次回請求返済日</label>
<input name='f910' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[329]) %>"><br>
<!--20180917 eSCOFI Dolpfin対応-->
<label class="tab_page_label" style='margin-left:36px'>最終一連番号</label>
<input name='f97' style='width:49px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[136]) %>">
<label class="tab_page_label" style='margin-left:80px'>最終変更取引番号</label>
<input name='f98' style='width:49px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[137]) %>">
<label class="tab_page_label" style='margin-left:20px;'>分割金適用期限</label>
<input name='f315' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[315]) %>" readonly tabindex='-1'><br>

<label class="tab_page_label" style='margin-left:36px;'>旧承認期限</label>
<input name='f87' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[125]) %>">
<label class="tab_page_label" style='margin-left:45px'>分割コード</label>
<input name='f113' style='width:154px;' value="<%= xp.xpd.node_value[154].trim() %>"><br>

<label class="tab_page_label" style='margin-left:36px'>約定日</label>
<input name='f81' style='width:29px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[117]) %>">
<!--<label style='margin-left:100px'>利息返済日</label>//-->
<input type='hidden'name='f82' style='width:84px;' value="<%= xp.xpd.node_value[118] %>">
<label class="tab_page_label" style='margin-left:100px;'>延滞コード</label>
<input name='f88' style='width:29px;' value="<%= xp.xpd.node_value[127] %>"><input name='f89' style='width:354px;' value="<%= xp.xpd.node_value[128] %>"><br>

<label class="tab_page_label" style='margin-left:36px'>次回元金返済日</label>
<input name='f83' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[121]) %>">
<label class="tab_page_label" style='margin-left:45px'>次回利息返済日</label>
<input name='f84' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[122]) %>">
<label class="tab_page_label" style='margin-left:-15px;'>延滞利率</label>
<input name='f92' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[131]) %>">%<br>

<label class="tab_page_label" style='width:134px; margin-left:22px;'>次回ボーナス元金返済日</label>
<input name='f85' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[123]) %>">
<label class="tab_page_label" style='width:134px; margin-left:31px;'>次回ボーナス利息返済日</label>
<input name='f86' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[124]) %>">
<label class="tab_page_label" style='margin-left:-15px;'>延滞開始日</label>
<input name='f94' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[133]) %>"><br>
...
<label class="tab_page_label" style='width:148px; margin-left:5px; font-size:11px;'>手数料パターン（臨時返済）</label>
...
<label class="tab_page_label" style='margin-left:-34px;'>元金延滞期間</label>
<input name='f93' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[132]) %>"><br>

<!--特約期間終了日--
<input name='f87_1' style='width:84px;' readonly tabindex='-1' value="xp.xpd.node_value[117]">!-->
<label class="tab_page_label" style='margin-left:36px;'>延滞帳発送日</label>
<input name='f95' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[134]) %>">
<label class="tab_page_label" style='margin-left:46px;'>管理進行状態 </label>
...
<input name='f96' style='width:308px;' value="<%= xp.xpd.node_value[135] %>"><br>

<label class="tab_page_label" style='margin-left:36px'>条件緩和区分</label>
<input name='f114' style='width:29px;' value="<%= xp.xpd.node_value[155] %>"><input name='f115' style='width:279px;' value="<%= xp.xpd.node_value[156] %>"><br>

<label class="tab_page_label" style='margin-left:36px'>条件緩和内容</label>
<input name='f116' style='width:604px;' value="<%= xp.xpd.node_value[157] %>"><br>
<input style='width:604px; margin-left:165px;' name='f117' value="<%= xp.xpd.node_value[158] %>"><br>
...
<tr>
	...
	<td><input name='f102' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[143]) %>"></td>
	<td nowrap style='text-align:right;width:203px;'><label class="tab_page_label">延滞回数</label></td>
	<td><input name='f103' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[144]) %>"></td>
	<td nowrap style='text-align:right;width:150px;'><label class="tab_page_label">延滞のべ回数</label></td>
	<td><input name='f101' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[142]) %>"></td>
</tr>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">延滞返済日数</label></td>
	<td><input name='f105' style='width:54px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[146]) %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">延滞日数</label></td>
	<td><input name='f106' style='width:54px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[147]) %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">延滞のべ日数</label></td>
	<td><input name='f104' style='width:54px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[145]) %>"></td>
</tr>
</table>
...
<table cellpadding='0' cellspacing='0' style='margin-left:40px'>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label" style="width:120px;">手数料減免回数</label></td>
	<td><input name='f99' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[140]) %>"></td>
	<td nowrap style='text-align:right;width:224px;'><label class="tab_page_label">当月繰上返済回数</label></td>
	<td><input name='f100' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[141]) %>"></td>
	<td nowrap style='text-align:right; width:156px;'><label class="tab_page_label" style="margin-left:111px;">最終自由繰上返済日</label></td>
	<td><input name='f302' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.makeDate(xp.xpd.node_value[150]) %>"></td>
</tr>
<!--tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">先払控除日数</label></td>
	<td--><input type='hidden' name='f107' style='width:54px;' value="<%= xp.xpd.node_value[148] %>"><!--/td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">先払控除残余日数</label></td>
	<td colspan='3'--><input type='hidden' name='f108' style='width:84px;' value="<%= xp.xpd.node_value[149] %>"><!--/td>
</tr-->
</table>
...
<tr>
	...
	<td><input name='f109' style='width:204px;' value="<%= xp.xpd.node_value[151].trim() %>"></td>
	<!--自動繰上開始日,自動繰上終了日追加-->
	<td ><label class="tab_page_label" style='width:100px'>自動繰上開始日</label></td>
	<td><input name='f802' style='width:84px;' readonly tabindex='-1' value="<%=  XmlUtil.makeDate(xp.xpd.node_value[308]) %>"></td>
	<td nowrap ><label class="tab_page_label" style='width:80px'>自動繰上終了日</label></td>
	<td><input name='f803' style='width:84px;' readonly tabindex='-1' value="<%=  XmlUtil.makeDate(xp.xpd.node_value[309]) %>"></td>
</tr>
<tr>
	<td nowrap><label class="tab_page_label">返済上限金額</label></td>


	<td><input name='f110' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[152] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap><label class="tab_page_label" style='width:100px'>最低引落単位</label></td>

	<td><input name='f112' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[153] ,xp.oheader.node_value[35]) %>"></td>

	<!-- 最低維持残高追加-->
	<td nowrap style='text-align:right;' ><label class="tab_page_label" style='width:80px'>最低維持残高</label></td>

	<td><input name='f905' style='width:134px;text-align:right' value= "<%= makemask7("17" ,xp.xpd.node_value[325] ,xp.oheader.node_value[35]) %>" readonly tabindex='-1'></td>
...
<tr>
	...
	<td><input name='f118' style='width:254px;' value="<%= xp.xpd.node_value[160] %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">担保設定種類</label></td>
	<td><input name='f119' style='width:154px;' value="<%= xp.xpd.node_value[161] %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label" style="width:134px">保証人数</label></td>
	<td colspan='3'><input name='f120' style='width:29px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[162]) %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">団体生命コード</label></td>
	<td><input name='f126' style='width:44px;' value="<%= xp.xpd.node_value[168] %>"><input name='f295' style='width:354px;' value="<%= xp.xpd.node_value[169] %>" readonly tabindex='-1'></td>
<!--<td><input name='f126' style='width:84px;' qtype='3154' onpropertychange='getDesc()'><input name='f126Lbl' style='width:154px;' readonly tabindex='-1'></td>-->
	<td nowrap style='text-align:right;'><label class="tab_page_label">団体生命契約区分</label></td>
	<td style='align:left'><input name='f127' type=checkbox style='width:34px;margin-left:-9px' <%= xp.xpd.node_value[170].trim().compareTo("y") == 0 ? "checked" : "" %>><label class="tab_page_label" style='margin-left:-50px'> check時 加入</label></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label" style="width:134px">被保険者人数</label></td>
	<td><input name='f128' style='width:44px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[171]) %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">団体生命保険番号</label></td>
	<td><input name='f129' style='width:184px;' value="<%= xp.xpd.node_value[172] %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label" style="width:134px">第1団信当初適用額</label></td>

<!-- AP 17.2 -->
	<td><input name='f130' style='width:154px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[173] ,xp.oheader.node_value[35]) %>"></td>

	<td nowrap style='text-align:right;'><label class="tab_page_label" style='/*width:80px;*/'>第2団信当初適用額</label></td>

<!-- AP 17.2 -->
	<td><input name='f131' style='width:154px;text-align:right' readonly value="<%= makemask7("17.2" ,xp.xpd.node_value[174] ,xp.oheader.node_value[35]) %>"></td>
...
<tr>
	...
	<td><input name='f311' style='width:29px;' value="<%= XmlUtil.nNullCheck(xp.xpd.node_value[311]) %>" readonly tabindex='-1'><input name='f312' style='width:369px;' value="<%= xp.xpd.node_value[312] %>" readonly tabindex='-1'></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">第3団信当初適用額</label></td>

<!-- AP 17.2 -->
	<td style='align:left'><input name='f313' style='width:154px;text-align:right' value="<%= makemask7("17.2" ,xp.xpd.node_value[313] ,xp.oheader.node_value[35]) %>" readonly tabindex='-1'></td>
...
<tr>
	...
	<td><input name='f121' style='width:44px;' qtype='3206' onpropertychange='getDesc()' pop='no' value="<%= xp.xpd.node_value[163].trim() %>"><input name='f121Lbl' style='width:354px;' readonly tabindex='-1'>
	<script>
			/* //origin
...
<tr>
	...
	<td><input name='f122' style='width:154px;' value="<%= xp.xpd.node_value[164] %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">保証協会保証番号</label></td>
	<td><input name='f123' style='width:154px;' value="<%= xp.xpd.node_value[165] %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label" style="width:134px">保証会社コード</label></td>
	<td><input name='f124' style='width:44px;' qtype='3207' onpropertychange='getDesc()' pop='no' value="<%= xp.xpd.node_value[166].trim() %>"><input name='f124Lbl' style='width:354px;' readonly tabindex='-1'>
	<script>
	...
	<td><input name='f125' style='width:154px;' value="<%= xp.xpd.node_value[167] %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">保証料徴求方式</label></td>
	<td><input name='f132' style='width:154px;' value="<%= xp.xpd.node_value[175] %>"></td>
</tr>
</table>
<br>
<label class="tab_page_label" style="width:134px">連帯債務者区分</label>
<input name='f133' style='width:104px;' value="<%= xp.xpd.node_value[176] %>">
<label class="tab_page_label" style='margin-left:424px;'>主債務者債務比率</label>
<input name='f134' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[177]) %>"> %<br>
<label class="tab_page_label" style="width:134px">連帯債務者顧客番号1</label>
<input name='f135' style='width:84px;' value="<%= XmlUtil.dataPattern("f",xp.xpd.node_value[178],10) %>"><input name='f303' style='width:454px;' value="<%= xp.xpd.node_value[179] %>" readonly tabindex='-1'>
<label class="tab_page_label" style='margin-left:-10px'>債務比率１</label>
<input name='f136' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[180]) %>"> %<br>
<label class="tab_page_label" style="width:134px">連帯債務者顧客番号2</label>
<input name='f137' style='width:84px;' value="<%= XmlUtil.dataPattern("f",xp.xpd.node_value[181],10) %>"><input name='f304' style='width:454px;' value="<%= xp.xpd.node_value[182] %>" readonly tabindex='-1'>
<label class="tab_page_label" style='margin-left:-10px'>債務比率２</label>
<input name='f138' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[183]) %>"> %<br>
<label class="tab_page_label" style="width:134px">連帯債務者顧客番号3</label>
<input name='f139' style='width:84px;' value="<%= XmlUtil.dataPattern("f",xp.xpd.node_value[184],10) %>"><input name='f305' style='width:454px;' value="<%= xp.xpd.node_value[185] %>" readonly tabindex='-1'>
<label class="tab_page_label" style='margin-left:-10px'>債務比率３</label>
<input name='f140' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[186]) %>"> %<br>
<label class="tab_page_label" style="width:134px">連帯債務者顧客番号4</label>
<input name='f141' style='width:84px;' value="<%= XmlUtil.dataPattern("f",xp.xpd.node_value[187],10) %>"><input name='f306' style='width:454px;' value="<%= xp.xpd.node_value[188] %>" readonly tabindex='-1'>
<label class="tab_page_label" style='margin-left:-10px'>債務比率４</label>
<input name='f142' style='width:34px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[189]) %>"> %<br>
<br>
	<!-- 振替委託区分追加-->
...
<option value="2" <%= ntemp == 2 ? "selected" : "" %>>他行直接引落</option>
	...
	<input name='f908' style='width:44px;' value="<%= xp.xpd.node_value[327].trim() %>" readonly tabindex='-1'><input name='f909' style='width:354px;' value="<%= xp.xpd.node_value[328] %>" readonly tabindex='-1'><br>
...
<tr>
	...
	<td><input name='f308' style='width:134px;' readonly tabindex='-1' value="<%= XmlUtil.dataPattern("a",xp.xpd.node_value[73],0) %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">親の関連口座番号</label></td>
	<td colspan='3'><input name='f309' style='width:134px;' readonly tabindex='-1' value="<%= XmlUtil.dataPattern("a",xp.xpd.node_value[74],0) %>"></td>
</tr>
</table><br>
...
<tr>
	...
	<td><input name='f146' style='width:44px;'  readonly tabindex='-1' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[194]) %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">固定金利特約期間</label></td>
	<td><input name='f147' style='width:44px;'  readonly tabindex='-1' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[195]) %>"></td>
</tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">特約期間終了日</label></td>
    <td colspan='3'><input name='f87_1' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.makeDate(xp.xpd.node_value[126]) %>"></td>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">次回金利変更日</label></td>
	<td><input name='f504' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.makeDate(xp.xpd.node_value[119]) %>"></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">次回分割金変更日</label></td>
	<td><input name='f505' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.makeDate(xp.xpd.node_value[120]) %>"></td>
</tr>
<tr>
...
<input name='f147' type='hidden' style='width:44px;' value="<%= xp.xpd.node_value[195] %>">
<input name='f150' type='hidden' style='width:84px;' value="<%= xp.xpd.node_value[198] %>">
<br><br>
...
<tr>
	...
	<td><input name='f153' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[199]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">商品加算利率</label></td>
	<td><input name='f154' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[200]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">商品減算利率</label></td>
	<td><input name='f155' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[201]) %>">%</td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">初回段階金利</label></td>
	<td><input name='f156' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[202]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">初回SPREAD金利</label></td>
	<td><input name='f157' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[203]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">商品利率</label></td>
	<td><input name='f158' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[204]) %>">%</td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">CAP利率</label></td>
	<td><input name='f159' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[205]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">FLOOR利率</label></td>
	<td><input name='f160' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[206]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">次期SPREAD利率</label></td>
	<td><input name='f161' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[207]) %>">%</td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">期間金利</label></td>
	<td><input name='f162' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[208]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">CAP期間SPREAD</label></td>
	<td><input name='f163' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[209]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">商品固定利率</label></td>
	<td><input name='f297' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[211]) %>">%</td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">顧客CAP</label></td>
	<td colspan='5'><input name='f165' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[212]) %>">%</td>
</tr>
<tr>
...
<tr>
	...
	<td><input name='f164' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[210]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">加算金利</label></td>
	<td><input name='f166' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[213]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">減算金利</label></td>
	<td><input name='f167' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[214]) %>">%</td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">利子補給率</label></td>
	<td><input name='f168' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[215]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">保証料率</label></td>
	<td><input name='f169' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[216]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">団体生命利率</label></td>
	<td><input name='f170' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[217]) %>">%</td>
</tr>
<tr>
	<td nowrap style='text-align:right;'><label class="tab_page_label">特約加算利率</label></td>
	<td><input name='f314' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[314]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">預金金利</label></td>
	<td><input name='f171' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[218]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">連動加算金利</label></td>
	<td><input name='f172' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[219]) %>">%</td>
</tr>
<tr>
	<td><label class="tab_page_label">貸越利率</label></td>
	<td><input name='f605' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[319]) %>">%</td>
	<td></td><td></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">適用利率</label></td>
	<td><input name='f173' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[220]) %>">%</td>
</tr>
</table>
<br><br>
...
<tr>
	...
	<td colspan='3'><input name='f176' style='width:49px;' qtype='3141' onpropertychange="getDesc()" pop="no"><input name='f176Lbl' style='width:354px;' readonly tabindex='-1'>
	<script>
...
<tr>
	...
	<td colspan='3'><input name='f175' style='width:49px;' value="<%= xp.xpd.node_value[222] %>"><input name='f175_1' style='width:354px;' readonly tabindex='-1' value="<%= xp.xpd.node_value[223] %>"></td>
</tr>
<tr>
	<td nowrap style='text-align:right'><label class="tab_page_label">優遇幅パターン</label></td>
	<td colspan='3'><input name='f174_1' style='width:49px;' readonly tabindex='-1'><input name='f174' style='width:354px;' value="<%= xp.xpd.node_value[226] %>"></td>
	<script>
...
<tr>
	...
	<td><input name='f245' style='width:49px;'><input name='f246' style='width:414px;' value="<%= xp.xpd.node_value[303] %>"></td>
	<script>
	...
	<td><input name='f247' style='width:49px; text-align:right' value="<%= XmlUtil.nNullCheck(xp.xpd.node_value[304]) %>"></td>
</tr>
<tr>
...
%>
	...
	</select><!--<input name='f177' style='width:84px;'>--></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">顧客優遇金利</label></td>
	<td><input name='f178' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[228]) %>">%</td>
</tr>
<tr>
...
%>
	<option value="0" <%= ntemp == 0 ? "selected" : "" %>>NO</option>
	<option value="1" <%= ntemp == 1 ? "selected" : "" %>>YES</option>
	</select><!--<input name='f179' style='width:84px;'>--></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">変動類型優遇金利</label></td>
	<td><input name='f180' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[230]) %>">%</td>
</tr>
<tr>
...
%>
	<option value="0" <%= ntemp == 0 ? "selected" : "" %>>NO</option>
	<option value="1" <%= ntemp == 1 ? "selected" : "" %>>YES</option>
	</select><!--<input name='f248' style='width:84px;'>--></td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">取引期間優遇金利</label></td>
	<td><input name='f249' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[306]) %>">%</td>
</tr>
<tr>
	<td nowrap style='text-align:right'><label class="tab_page_label">最大優遇幅</label></td>
	<td><input name='f181' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[231]) %>">%</td>
	<td nowrap style='text-align:right;'><label class="tab_page_label">適用優遇金利</label></td>
	<td><input name='f182' style='width:84px;' value="<%= XmlUtil.checkValue("03","7.5",xp.xpd.node_value[232]) %>">%</td>
</tr>
</table><br>
<br>
...
<table cellpadding='0' cellspacing='0' style='margin-left:50px;'>
	<tr>
		...
		<td><input name='f183' style='width:29px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[234]) %>"></td>
		<td nowrap style='text-align:right;'><label class="tab_page_label">残高証明発行減免額</label></td>

		<td><input name='f185' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[236] ,xp.oheader.node_value[35]) %>"></td>

<!--    <td nowrap style='text-align:right;'><label class="tab_page_label">残高証明書証明日</label></td-->
		<td><input name='f184' type='hidden' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[235]) %>"></td>
	</tr>
	<tr>
		<td nowrap style='text-align:right;'><label class="tab_page_label">残高証明書発行手数料</label></td>
<!--	<td><input name='f186' style='width:154px;'></td>-->
		<td><input name='f298' style='width:29px;' readonly tabindex='-1' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[237]) %>"><input name='f299' style='width:204px;' readonly tabindex='-1' value="<%= xp.xpd.node_value[238].trim() %>"></td>
	</tr>
</table><br>
...
<table cellpadding='0' cellspacing='0' style='margin-left:50px;'>
	<tr>
		<td nowrap style='text-align:right;'><label class="tab_page_label">発行枚数</label></td>
		<td><input name='f199' style='width:29px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[251]) %>"></td>
		<td width='200'></td>
		<td nowrap style='text-align:right;'><label class="tab_page_label">利息証明発行減免額</label></td>

		<td><input name='f200' style='width:134px; text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[252] ,xp.oheader.node_value[35]) %>"></td>

	</tr>
	<tr>
		<td nowrap style='text-align:right;'><label class="tab_page_label">利息証明書発行手数料</label></td>
<!--	<td colspan='2'><input name='f201' style='width:154px;'></td>-->
		<td colspan='3'><input name='f300' style='width:29px;' readonly tabindex='-1' value="<%= xp.xpd.node_value[253] %>"><input name='f301' style='width:204px;' readonly tabindex='-1' value="<%= xp.xpd.node_value[254].trim() %>"></td>
	</tr>
</table><br>
...
<table cellpadding='0' cellspacing='0' style="margin-left:50px">
	<tr>
		...
		<td><input name='f238' style='width:84px;' value="<%= XmlUtil.makeDate(xp.xpd.node_value[291]) %>"></td>
		<td width='50'></td>
		<td nowrap style='text-align:right;'><label class="tab_page_label">減税証明書当初貸出額</label></td>

		<td><input name='f239' style='width:134px;text-align:right' readonly value="<%= makemask7("14.2" ,xp.xpd.node_value[292] ,xp.oheader.node_value[35]) %>"></td>

		<!-- 減税証明発行期間追加-->
		<td nowrap style='text-align:right;'><label class="tab_page_label">減税証明発行期間</label></td>
		<td><input name='f804' style='width:34px;text-align:right;' readonly tabindex='-1' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[310]) %>"></td>
	</tr>
	<tr>
...
%>
		...
		<td nowrap style='text-align:right;'><label class="tab_page_label">発行枚数</label></td>
		<td><input name='f241' style='width:29px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[294]) %>"></td>
	</tr>
	<tr>
		<td nowrap style='text-align:right;'><label class="tab_page_label">租税特別措置項</label></td>
		<td><input name='f242' style='width:29px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[295]) %>"></td>
		<td>&nbsp;</td>
		<td nowrap style='text-align:right;'><label class="tab_page_label">租税特別措置号</label></td>
		<td><input name='f243' style='width:29px;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[296]) %>"></td>
		<td nowrap style='text-align:right;'><label class="tab_page_label">賦払期間</label></td>
		<td><input name='f244' style='width:34px;text-align:right;' value="<%= XmlUtil.strZeroNullCheck(xp.xpd.node_value[297]) %>"></td>
	</tr>
</table>
</div>
...
<table border=0 cellpadding='0' cellspacing='0' style="text-align:left;margin-left:30px">
	...
	<tr>
		...
		<td><input name='f356' style='width:84px;text-align:right;' readonly tabindex='-1' value="<%= XmlUtil.makeDate(xp.xpd.node_value[337]) %>"></td>
	...
	<tr>
		...
		<td><input name='f357' style='width:134px;text-align:right' value="<%= makemask7("17.2" ,xp.xpd.node_value[338] ,xp.oheader.node_value[35]) %>" readonly tabindex='-1'></td>
	...
	<tr>
		...
		<td><input name='f358' style='width:84px;text-align:right;' readonly tabindex='-1' value="<%= XmlUtil.makeDate(xp.xpd.node_value[339]) %>"></td>
	...
	<tr>
		...
		<td><input name='f359' style='width:134px;text-align:right' value="<%=XmlUtil.checkValue("03","12.6",xp.xpd.node_value[340]) %>" readonly tabindex='-1'>&nbsp;円 （為替予約金額）</td>
	...
	<tr>
		...
		<td><input name='f360' style='width:134px;text-align:right' value="<%= XmlUtil.checkValue("02","17.2",xp.xpd.node_value[341]) %>" readonly tabindex='-1'>&nbsp;円</td>
...
<table border=0 cellpadding='0' cellspacing='0' style="text-align:left;margin-left:30px">
	...
	<tr>
		...
		<td><input name='f362' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.makeDate(xp.xpd.node_value[344]) %>"></td>
		<td nowrap style='text-align:left;'><label class="tab_page_label">今回約定日</label></td>
		<td><input name='f363' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.makeDate(xp.xpd.node_value[345]) %>"></td>
	</tr>
	<tr>
		<td nowrap style='text-align:left;'><label class="tab_page_label">最終約定充当日</label></td>
		<td><input name='f364' style='width:84px;' readonly tabindex='-1' value="<%= XmlUtil.makeDate(xp.xpd.node_value[346]) %>"></td>
	</tr>
	<tr>
		<td nowrap style='text-align:left;'><label class="tab_page_label">今回約定返済額</label></td>
		<td><input name='f365' style='width:134px;text-align:right' value="<%= XmlUtil.checkValue("02","17.2",xp.xpd.node_value[347]) %>" readonly tabindex='-1'></td>
		<td nowrap style='text-align:left;'><label class="tab_page_label">今回約定充当額</label></td>
		<td><input name='f366' style='width:134px;text-align:right' value="<%= XmlUtil.checkValue("02","17.2",xp.xpd.node_value[348]) %>" readonly tabindex='-1'></td>
	</tr>
	<tr>
		<td nowrap style='text-align:left;'><label class="tab_page_label">未収手数料合計</label></td>
		<td><input name='f367' style='width:134px;text-align:right' value="<%= XmlUtil.checkValue("02","17.2",xp.xpd.node_value[349]) %>" readonly tabindex='-1'>
		...
		<td><input name='f368' style='width:134px;text-align:right' value="<%= XmlUtil.checkValue("02","17.2",xp.xpd.node_value[350]) %>" readonly tabindex='-1'>
		<!--20210204 EK Button Add-->
	...
	<tr>
		...
		<td><input name='f369' style='width:134px;text-align:right' value="<%= XmlUtil.checkValue("02","17.2",xp.xpd.node_value[351]) %>" readonly tabindex='-1'></td>
	</tr>
