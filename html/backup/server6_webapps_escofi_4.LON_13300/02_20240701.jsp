...
<label class="tab_page_label" style="width:135px;"><script>w1('CLASSTYP3')</script></label>
...
<input name='f3' style='width:150px;' onpropertychange='u_moveValue()'
onblur="u_autoPadding()" value='<%= f6 %>'> <!--  20160321---------->

<label class="tab_page_label" style="margin-left:90px;"><script>w1('LONREQDT')</script></label>
<input name='f58_1' style='width:40px;'><input name='f58_2' style='width:25px;'><input name='f58_3' style='width:25px;'>
<input name='f58' type='hidden'><br>

<label class="tab_page_label" style="margin-left:36px;"><script>w1('SOLIEMPNO')</script></label>
<input name='f4' qtype='28' style="width:80px;" maxlength='10' value='<%= f26 %>'><input name='f4Lbl' style="width:200px;" readonly tabindex=-1>
<label class="tab_page_label" style='margin-left:-40px;'><script>w1('MGREMPNM')</script></label>
<input name='f5' qtype='28' style="width:80px;" maxlength='10' value='<%= f27 %>'><input name='f5Lbl' style="width:200px;" readonly tabindex=-1><br>

<label class="tab_page_label" style="margin-left:36px;"><script>w1('SGTPROPNO')</script></label>
<input name='f409' qtype='28' style="width:80px;" maxlength='10' pop='no' readonly tabindex='-1' value='<%= f409 %>'><input name='f409Lbl' style="width:200px;" readonly tabindex=-1 value='<%= f409Lbl %>'><br>

<label class="tab_page_label" style="margin-left:36px;"><script>w1('RELTCNSLNO')</script></label>
<input name='f435_1' style="width:140px;" readonly tabindex=-1><input name='f435' type='hidden' style="width:140px;" readonly tabindex=-1 value='<%= f435 %>'>
<label class="tab_page_label" style="margin-left:100px;"><script>w1('LONTOTAMT')</script></label>
<input name='f436' style='width:130px;' readonly tabindex='-1' value='<%= f436 %>'><br>

<label class="tab_page_label" style="margin-left:36px;"><script>w1('LIFEINSUAMT3')</script></label>
<input name='f410' style='width:130px;' value='<%= f410 %>'>
<label class="tab_page_label" style="margin-left:110px;"><script>w1('LIFEINSUAMT4')</script></label>
<input name='f411' style='width:130px;' value='<%= f411 %>'><br>

<label class="tab_page_label" style="margin-left:36px;"><script>w1('GUARTYPE')</script></label>
<input name='f426' style="width:25px;" qtype="3400" master="f297" master2="execday" onpropertychange='localQuery2()' value='<%= f426 %>'><input name='f426Lbl' style="width:220px;" readonly tabindex=-1 value='<%= f426Lbl %>'><br>
...
<label class="tab_page_label" style="width:161px; padding:0; font-size:11px; margin-left:130px;"><script>w1('FEEPATN2')</script></label>
...
<input name='f445_1' type='hidden' value='<%= f445_1 %>'><input name='f445_3' type='hidden' value='<%= f445_3 %>'><input name='f445_2' style="width:80px;" value='<%= f445_2 %>' onpropertychange='u_reqcheck()'>
...
<input name='f444_1' qtype='4084' style='width:36px;' maxlength='4' onpropertychange="getBankName1();" value='<%= f444_1 %>' ><input name='f444_1Lbl' style='width:240px;' maxlength='30' readonly tabindex='-1' value='<%= f444_1Lbl %>' >

<!-- 支店 -->
<label class="tab_page_label" style="margin-left:-40px;"><script>w1('NBR')</script></label>
<input name='f444_2' qtype='4085' style='width:36px;' maxlength='4' master="f444_1" onpropertychange="getShitenName1();" value='<%= f444_2 %>'><input name='f444_2Lbl' style='width:240px;' readonly tabindex='-1' value='<%= f444_2Lbl %>'><br>

<!-- 種別-->
<label class="tab_page_label" style="margin-left:36px;"><script>w1('KIND')</script></label>
<input name='f444_3' style='width:20px;' maxlength='2' qtype='3999' onpropertyChange="getDesc()" value='<%= f444_3 %>'><input name='f444_3Lbl' style='width:90px;' readonly tabindex='-1' value='<%= f444_3Lbl %>'>

<!-- 口座番号 -->
<label class="tab_page_label" style="margin-left:130px;"><script>w1('DEP_ACCT_NO')</script></label><input name='f444_4' style='width:160px;' maxlength='7' value='<%= f444_4 %>'><br>

<!-- 20200331 Ek Edit Start -->
<!-- 引落名義(カナ) -->
<label class="tab_page_label" style="margin-left:40px;"><script>w1('DEP_ACCT_NAME_KANA')</script></label></label><input name='f461' style='width:450px;' maxlength='30' value='<%= f461 %>'>
<br><br>
<!-- 20200331 Ek Edit End -->
...
<!-- 銀行 -->
<label class="tab_page_label" style="margin-left:36px;"><script>w1('BANK')</script></label>
<input name='f508_1' qtype='4084' style='width:36px;' maxlength='4' onpropertychange="getBankName2();"  value='<%= f508_1 %>'><input name='f508_1Lbl' style='width:240px;' maxlength='30' readonly tabindex='-1' value='<%= f508_1Lbl %>' >

<!-- 支店 -->
<label class="tab_page_label" style="margin-left:-40px;"><script>w1('NBR')</script></label>
<input name='f508_2' qtype='4085' style='width:36px;' maxlength='4' master="f508_1" onpropertychange="getShitenName2();" value='<%= f508_2 %>'><input name='f508_2Lbl' style='width:240px;' readonly tabindex='-1' value='<%= f508_2Lbl %>'><br>

<!-- 種別 -->
<label class="tab_page_label" style="margin-left:36px;"><script>w1('KIND')</script></label>
<input name='f508_3' style='width:20px;' maxlength='2' qtype='3999' onpropertyChange="getDesc()" value='<%= f508_3 %>'><input name='f508_3Lbl' style='width:90px;' readonly tabindex='-1' value='<%= f508_3Lbl %>'>

<!-- 口座番号 -->
<label class="tab_page_label" style="margin-left:130px;"><script>w1('DEP_ACCT_NO')</script></label><input name='f508_4' style='width:160px;' maxlength='7' value='<%= f508_4 %>'><br>

<!-- 口座名義(カナ) -->
<label class="tab_page_label" style="margin-left:40px;"><script>w1('DEPACCTNAME')</script></label></label><input name='f509' style='width:450px;' maxlength='30' value='<%= f509 %>'>
<br><br>


<label class="tab_page_label" style="margin-left:36px;"><script>w1('LOANISSUMETHOD')</script></label>
<input name='f6' style="width:25px;" qtype='3210' onpropertychange="show()" onblur="u_autotwo(this.value)" value='<%= f28 %>'><input name='f6Lbl' style="width:160px;" readonly tabindex=-1 value='<%= f6Lbl %>'><br>
...
<span id='d2' style="display:none;"><!--show2()-->
	...
	<input name='f413_3' style='width:80px;' onpropertychange="doCheckInputFields(this);" value='<%= f413_3 %>'><input name='ciff413' style='width:400px;' maxlength='30' readonly tabindex='-1'>
	...
	<input name='f414' style='width:30px;' onblur="u_joinChange('p906','f414','f416','f418','f420','f412')" value='<%= f414 %>'>%<br>

	<label class="tab_page_label" style="margin-left:36px;"><script>w1('JOINJOINCIF2')</script></label>
	<input name='f415_3' style='width:80px;' onpropertychange="doCheckInputFields(this);" value='<%= f415_3 %>'><input name='ciff415' style='width:400px;' maxlength='30' readonly tabindex='-1'>
	...
	<input name='f416' style='width:30px;' onblur="u_joinChange('p906','f414','f416','f418','f420','f412')" value='<%= f416 %>'>%<br>

	<label class="tab_page_label" style="margin-left:36px;"><script>w1('JOINJOINCIF3')</script></label>
	<input name='f417_3' style='width:80px;' onpropertychange="doCheckInputFields(this);" value='<%= f417_3 %>'><input name='ciff417' style='width:400px;' maxlength='30' readonly tabindex='-1'>
	...
	<input name='f418' style='width:30px;' onblur="u_joinChange('p906','f414','f416','f418','f420','f412')" value='<%= f418 %>'>%<br>

	<label class="tab_page_label" style="margin-left:36px;"><script>w1('JOINJOINCIF4')</script></label>
	<input name='f419_3' style='width:80px;' onpropertychange="doCheckInputFields(this);" value='<%= f419_3 %>'><input name='ciff419' style='width:400px;' maxlength='30' readonly tabindex='-1'>
	...
	<input name='f420' style='width:30px;' onblur="u_joinChange('p906','f414','f416','f418','f420','f412')" value='<%= f420 %>'>%<br>
...
<span id='d' style="display:none;"><!--show()-->
	...
	<input name='f59' style='width:25px;' maxlength=1 onblur="u_divissu()" value='<%= f85 %>'>
	...
	<input style="margin-left:205px;" name='f60_1' style='width:40px;' disabled=true value='<%= f86_1 %>'><input name='f60_2' style='width:25px;' disabled=true value='<%= f86_2 %>'><input name='f60_3' style='width:25px;' disabled=true value='<%= f86_3 %>'><input  style="margin-left:50px;" name='f421' style='width:150px;' disabled=true value='<%= f421 %>' onblur="u_autoPadding()"><br>
	<input style="margin-left:205px;" name='f61_1' style='width:40px;' disabled=true value='<%= f87_1 %>'><input name='f61_2' style='width:25px;' disabled=true value='<%= f87_2 %>'><input name='f61_3' style='width:25px;' disabled=true value='<%= f87_3 %>'><input  style="margin-left:50px;" name='f422' style='width:150px;' disabled=true value='<%= f422 %>' onblur="u_autoPadding()" ><br>
	<input style="margin-left:205px;" name='f62_1' style='width:40px;' disabled=true value='<%= f88_1 %>'><input name='f62_2' style='width:25px;' disabled=true value='<%= f88_2 %>'><input name='f62_3' style='width:25px;' disabled=true value='<%= f88_3 %>'><input  style="margin-left:50px;" name='f423' style='width:150px;' disabled=true value='<%= f423 %>' onblur="u_autoPadding()"><br>
	<input style="margin-left:205px;" name='f63_1' style='width:40px;' disabled=true value='<%= f89_1 %>'><input name='f63_2' style='width:25px;' disabled=true value='<%= f89_2 %>'><input name='f63_3' style='width:25px;' disabled=true value='<%= f89_3 %>'><input  style="margin-left:50px;" name='f424' style='width:150px;' disabled=true value='<%= f424 %>' onblur="u_autoPadding()" ><br>
	<input style="margin-left:205px;" name='f64_1' style='width:40px;' disabled=true value='<%= f90_1 %>'><input name='f64_2' style='width:25px;' disabled=true value='<%= f90_2 %>'><input name='f64_3' style='width:25px;' disabled=true value='<%= f90_3 %>'><input  style="margin-left:50px;" name='f425' style='width:150px;' disabled=true value='<%= f425 %>' onblur="u_autoPadding()" ><br>
</span>
...
<input name='f44' style="width:30px;" qtype="3301" master="f211"  onpropertychange="getCodes(this.value)" value='<%= f67 %>'><input name='f44Lbl' style="width:400px;" readonly tabindex=-1 value='<%= f448 %>'><br>
<!--元金返済方式-->
...
<input name='f47' style="width:25px;" qtype="3302" master="f44" onkeyup="label2();u_autoinit()" maxlength='2' value='<%= f70 %>'><input name='f47Lbl' style="width:160px;" readonly tabindex=-1 value='<%= f449 %>'>
<!--利息返済周期-->
<label class="tab_page_label" style='margin-left:55px;'><script>w1('INTPAYBKCYCL')</script></label>
<input name='f48' style="width:25px;" qtype="3303" master="f47" master2="f44" onkeyup="label3();u_autoinit()" maxlength='2' value='<%= f71 %>'><input name='f48Lbl' style="width:160px;" readonly tabindex=-1 value='<%= f450 %>'><br>
<!--返済方式種類-->
...
<input name='f50' style='width:130px;' onpropertychange="cal11()" onblur="u_autoPadding()" value='<%= f75 %>'>

<!--ボーナス月-->
<label class="tab_page_label" style='margin-left:110px;'><script>w1('BNSREPAYMON')</script></label>
<input name='f51' style='width:20px;'  onfocus="cal12()" onpropertychange="cal14()">,<input name='f52' style='width:20px;' value='<%= f77 %>' readonly tabindex='-1'><br>
<!--毎回分割金-->
<label class="tab_page_label"><script>w1('EACHPARTAMT')</script></label>
<input name='f53' style='width:130px;' value='<%= f79 %>'>
<!--ボーナス毎回分割金-->
<label class="tab_page_label" style='margin-left:110px;'><script>w1('BNSEACHPARTAMT')</script></label>
<input name='f54' style='width:130px;' onblur="bnsAMT_check()" value='<%= f80 %>'><br>
<!--分割金適用期間-->
<label class="tab_page_label"><script>w1('AMTAPPLTERM')</script></label>
<input name='f150' style="width:30px;" value='<%= f150 %>'><br><br>
<!--期日区分-->
...
<input name='f35_1' style='width:40px;' onblur="repay_change()" value='<%= f57_1 %>'><input name='f35_2' style='width:20px;' onblur="repay_change()" value='<%= f57_2 %>'><input name='f35_3' style='width:20px;' onblur="repay_change()" value='<%= f57_3 %>'>
<!--返済月数-->
<label class="tab_page_label"><script>w1('RIMBMNS')</script></label>
<input name='f36' style='width:30px;' onblur="repay_change()" value='<%= f58 %>'><input type='hidden' name='f37' style='width:80px;' value='<%= f59 %>'><br>
<!--据置区分-->
...
<input name='f39_1' style='width:40px;' value='<%= f61_1 %>'><input name='f39_2' style='width:20px;' value='<%= f61_2 %>'><input name='f39_3' style='width:20px;' value='<%= f61_3 %>'>
<!--据置月数-->
<label class="tab_page_label"><script>w1('EXPMTHS')</script></label>
<input name='f40' style='width:30px;' value='<%= f62 %>'><input type='hidden' name='f41' style='width:80px;' value='<%= f63 %>'><br>
<!--約定日-->
<label class="tab_page_label"><script>w1('THEDATE')</script></label>
<input name='f42' style='width:25px;' onblur='cal13()' value='<%= f64 %>'><br>
<input name='f43' type='hidden' value='<%= f66 %>'><br><!--振込猶予区分-->
<!--返済資源-->
<label class="tab_page_label"><script>w1('REPAYFUND')</script></label>
<input name='f55' style='width:360px;' maxlength='20' value='<%= f81 %>'><br>
<!--返済方式-->
<label class="tab_page_label"><script>w1('RIMBMTHD')</script></label>
<input name='f56' style='width:360px;' maxlength='20' value='<%= f82 %>'><br>
<!--期待効果-->
<label class="tab_page_label"><script>w1('EXPECEFF')</script></label>
<input name='f57' style='width:360px;' maxlength='20' value='<%= f83 %>'><br>
</div>
...
<input name='f9'  qtype="3314" master="glDay" master2="f211" slave="f10"  style="width:30px;" onpropertychange="changeValue0();changeView4()" value='<%= f31 %>'><input name='f9Lbl' style="width:270px;" readonly tabindex=-1 value='<%= f9Lbl %>'>
<label class="tab_page_label" style="margin-left:-10px;"><script>w1('BASERATECODE')</script></label>
<input name='f10' qtype="3305" master="glDay" master2="f9" master3="f211" style="width:30px;" onpropertychange="localQuery10()" value='<%= f32 %>'><input name='f10Lbl' style="width:270px;" readonly tabindex=-1 value='<%= f10Lbl %>'><br>

<label class="tab_page_label"><script>w1('CAPSELECTTERM')</script></label>
<input name='f11' style="width:30px;" qtype="8001" pop='no' f3ESC='Y' master="f211" master2="f9" master3="f10" master4="ichaMonth" master5="glDay" onpropertychange="searchrate1();" value='<%= f33 %>' maxlength="3">
<label class="tab_page_label" style="margin-left:260px;"><script>w1('FIXRATESPCTYP')</script></label>
<input name='f12' style='width:30px;' qtype="7001" pop='no' f3ESC='Y' master="f211" master2="f9" master3="f10" master4="ichaMonth" master5="glDay" onpropertychange="searchrate2();" value='<%= f34 %>'><br>

<label class="tab_page_label"><script>w1('NEXTCHPCODE')</script></label>
<input name='f13' style='width:30px;' qtype="3324" master="glDay" master2="f211" slave="f14" onpropertychange='searchrate3()' value='<%= f35 %>'><input name='f13Lbl' style='width:270px;' readonly tabindex='-1' value='<%= f451 %>'>
<label class="tab_page_label" style="margin-left:-10px;"><script>w1('NEXTBASERATECODE')</script></label>
<input name='f14' style='width:30px;' qtype="3305" master="glDay" master2="f13" master3="f211" onpropertychange='searchrate4()' value='<%= f36 %>'><input name='f14Lbl' style='width:270px;' readonly tabindex='-1' value='<%= f452 %>'><br>

<label class="tab_page_label"><script>w1('SPECCODE')</script></label>
<input name='f503' style='width:30px;' qtype="3427" master="f211" onpropertychange='searchrate5()' onblur='changeField7()' maxlength='2' value='<%= f503 %>'><input name='f503Lbl' style='width:270px;' readonly tabindex='-1' value='<%= f458 %>'>
<label class="tab_page_label" style="margin-left:-10px;"><script>w1('LIFEINSUAMT5')</script></label>
<input name='f504' style='width:130px;' value='<%= f504 %>'><br>
...
<input name='f16'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f38 %>'><!--PRIME RATE-->
<label class="tab_page_label"><script>w1('PLUSRATE')</script></label>
<input name='f18'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f40 %>'><!--An article addition rate-->
<label class="tab_page_label"><script>w1('MINUSRATE')</script></label>
<input name='f19'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();u_pattern2();" value='<%= f41 %>'><!--An article subtraction rate--><br>
<label class="tab_page_label"><script>w1('FSTGRADRATE')</script></label>
<input name='f20'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f42 %>'><!--A first time stage interest rate-->
<label class="tab_page_label"><script>w1('FSTSPREADRATE')</script></label>
<input name='f21'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f43 %>'><!--A first time SPREAD interest rate-->
<label class="tab_page_label"><script>w1('GRPRATE')</script></label>
<input name='f17'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal32();" value='<%= f39 %>'><!--An article rate--><br>
<label class="tab_page_label"><script>w1('CAP')</script></label>
<input name='f22'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal40();" value='<%= f44 %>'><!--A CAP rate-->
<label class="tab_page_label"><script>w1('FLOOR')</script></label>
<input name='f23'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f45 %>'><!--An FLOOR rate-->
<label class="tab_page_label"><script>w1('NEXTSPREADRATE')</script></label>
<input name='f24'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f46 %>'><!--A next SPREAD rate--><br>
<label class="tab_page_label"><script>w1('TERMRATE')</script></label>
<input name='f25'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f47 %>'><!--A period interest rate-->
<label class="tab_page_label"><script>w1('CAPTERMSPREADRATE')</script></label>
<input name='f26'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f48 %>'><!--CAP period SPREAD-->
<label class="tab_page_label"><script>w1('PRODFIXRATE')</script></label>
<input name='f438' style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();"><!--An article fixation rate--><br>
<label class="tab_page_label"><script>w1('CIFCAP')</script></label>
<input name='f441' style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal32()"><!--Customer CAP--><br><br>

<!--fix fee-->
<label class="tab_page_label"><script>w1('FIXRATE')</script></label>
<input name='f27' style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding()"><!--A decision interest rate-->
<label class="tab_page_label"><script>w1('INCRS')</script></label>
<input name='f28' style='width:80px;' onkeydown="allowFloat()" onKeyup="checkFloat()" onblur="u_autopadding()" onpropertychange="cal32();" value='<%= f50 %>'><!--An addition interest rate-->
<label class="tab_page_label"><script>w1('PDCRS')</script></label>
<input name='f29' style='width:80px;' onkeydown="allowFloat()" onKeyup="checkFloat()" onblur="u_autopadding()" onpropertychange="cal32()" value='<%= f51 %>'><!--A subtraction interest rate--><br>
<label class="tab_page_label"><script>w1('SUPPRATE')</script></label>
<input name='DEPRATE' style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f111 %>'><!--The interest supplying rate-->
<label class="tab_page_label"><script>w1('GUARRATE')</script></label>
<input name='f401' style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal40();cal32();" value='<%= f401 %>'><!--Guarantee rate-->
<label class="tab_page_label"><script>w1('CORPLIFERATE')</script></label>
<input name='f402' style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f402 %>'><!--A group life rate--><br>
<label class="tab_page_label"><script>w1('SPECADDRATE')</script></label>
<input name='f505' style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();cal40();cal32();" value='<%= f505 %>'>
<label class="tab_page_label"><script>w1('DEPRATE')</script></label>
<input name='f30'  style='width:80px;' readonly tabindex=-1 onkeydown='allowFloat()' onkeyup='checkFloat()' onblur='u_autopadding()' value='<%= f52 %>'><!--Deposit rates-->
<label class="tab_page_label"><script>w1('TRFMAGRATE')</script></label>
<input name='f33'  style='width:80px;' readonly tabindex=-1 onkeydown='allowFloat()' onkeyup='checkFloat()' onblur='u_autopadding()' value='<%= f55 %>'><!--An interlocking movement addition interest rate--><br>
...
<label class="tab_page_label" style="margin-left:213px;"><script>w1('CURTRATE')</script></label>
<input name='f32'  style='width:80px;' readonly tabindex=-1 onpropertychange="u_autopadding();" value='<%= f54 %>'><!--An application rate-->
...
<input name='f408' qtype='3141' style='width:45px;' onpropertychange="label4();getDesc()" onblur="u_coalpadding()" value='<%= f408 %>'><input name='f408Lbl' style='width:200px;' readonly tabindex='-1' value='<%= f408Lbl %>'>
<label class="tab_page_label"><script>w1('INSTNO')</script></label>
<input name='f407' qtype='3142' master='glDay' master2='f408' style='width:45px;' onblur="u_padding()" onkeyup="clslabel()" value='<%= f407 %>'><input name='f407Lbl' style='width:200px;' readonly tabindex='-1' value='<%= f407Lbl %>'><br>
<label class="tab_page_label" style='margin-left:17px;'><script>w1('PRIPATTERN')</script></label>
<input name='f408_1' style='width:45px;' qtype='80' onpropertychange='u_pattern1()' value='<%= f500 %>'><input name='f408_1Lbl' style='width:200px;' readonly tabindex='-1' value='<%= f500Lbl %>'><br>
...
<input name='f31' style='width:80px;' onpropertychange="u_autopadding();changeValue4();" readonly tabindex='-1' value='<%= f53 %>'><br>
...
<input name='f439' style='width:80px;' onpropertychange='u_autopadding();changeValue4()' readonly tabindex='-1'><br>

<label class="tab_page_label" style="margin-left:17px;"><script>w1('MAXPRIVRATE')</script></label>
<input name='f406' style='width:80px;' onkeydown='allowFloat()' onkeyup='checkFloat()' onblur='u_autopadding();changeValue4();' value='<%= f406 %>'>
<label class="tab_page_label" style="margin-left:167px;"><script>w1('APLPRIVRATE')</script></label>
<input name='f440' style='width:80px;' onpropertychange='u_autopadding();cal32()' readonly tabindex='-1'><br><br>
...
<input name='f151' style='width:80px;' onblur='u_autopadding()'>%<br><input name='old151' type='hidden' value='<%= f151 %>'>
...
<% for (int i=0; i<60; i++) { %>
	<tr bgcolor=white align='center'>
        ...
        <td id="td154"><input name='f154' class=xInput style='width:170px;text-align:right' value='<%= (i < nLoop8) ? f154[i]:"" %>' onkeydown='allowNumber()' onkeyup='fCurrency2()' onblur='u_compare2()' onFocus='u_focus()' iLen=15 fLen=0 mask='02'></td>
	</tr>
<%  } %>
</table>
</span><br>
...
<input name='f601' style='width:150px;text-align:right' onpropertychange='u_moveValue()' onblur="u_autoPadding()" value='<%= f601 %>'><br>  <!--  20160331---------->
<!-- 印紙代 -->
<label class="tab_page_label" style='margin-left:20px;'><script>w1('STAMPTAX')</script></label>
<input name='f602' style='width:150px;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()"  value='<%= f602 %>'><br>  <!--  20160331---------->
<!-- 公証費用 -->
<label class="tab_page_label" style='margin-left:20px;'><script>w1('KJFEE')</script></label>
<input name='f603' style='width:150px;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()" value='<%= f603 %>'><br>  <!--  20160331---------->
<!-- 火災保険料 -->
<label class="tab_page_label" style='margin-left:20px;'><script>w1('INSUFEE')</script></label>
<input name='f604' style='width:150px;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()" value='<%= f604 %>'><br>  <!--  20160331---------->
<!-- 担保調査費用 -->
<label class="tab_page_label" style='margin-left:20px;'><script>w1('OUTCOLLRESFEE')</script></label>
<input name='f605' style='width:150px;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()" value='<%= f605 %>'><br>   <!--  20160331---------->
<!-- 確定日付料 -->
<label class="tab_page_label" style='margin-left:20px;'><script>w1('FIXDATEFEE')</script></label>
<input name='f606' style='width:150px;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()" value='<%= f606 %>'><br>    <!--  20160331---------->
<!-- 登記費用 -->
<label class="tab_page_label" style='margin-left:20px;'><script>w1('DKFEE')</script></label>
<input name='f607' style='width:150px;text-align:right' onpropertychange='u_moveValue()'   onblur="u_autoPadding()" value='<%= f607 %>'><br>    <!--  20160331---------->
<!-- 差引後顧客口座入金金額 -->
<label class="tab_page_label" style='width:fit-content; margin-left:8px;'><script>w1('NETDEPTOTAMT')</script></label>
<input name='f608' style='width:150px;text-align:right' readonly tabindex='-1' >   <!--  20160331---------->
