...
<input type='hidden' name='f1_1'><input name='f1_2' style='width:40' readonly tabindex='-1'><input name='f1_3' style='width:40' readonly tabindex=-1><input name='f1_4' style='width:20' readonly tabindex='-1'><input name='f1_5' style='width:60' readonly tabindex='-1'><label>
<script>w1('CURRENCYCD')</script></label> <input name='f100'  style='width:40' readonly ></input><br>  <!--20160321fx add ---->
<label><script>w1('CIF')</script></label>
<input type='hidden' name='CIF_1' value='<%= f9_1 %>'><input type='hidden' name='CIF_2' value='<%= f9_2 %>'><input name='CIF_3' style='width:80'  value='<%= f9_3 %>'><input name='CIFNAME' style='width:600' value='<%= f10 %>'><br>
<!--<label><script>w1('APPRTYPE')</script></label>--><input type='hidden' name='f2'><br>
</p>
<div class='TabUI'>
...
<input name='f220' style='width:40' onpropertychange="u_getGuarType(this.value)" readonly tabindex=-1 pop="no" value='<%= f19 %>'><input name='f220Lbl' style='width:240' readonly tabindex='-1'><br>
...
<input type='hidden' name='f222_1' value='<%= f21_1 %>'><input type='hidden' name='f222_2'  value='<%= f21_2 %>'><input name='f222_3' style='width:40' readonly tabindex=-1 value='<%= f21_3 %>'><input name='f222_4' style='width:25' readonly tabindex=-1 value='<%= f21_4 %>'><input name='f222_5' style='width:60' readonly tabindex=-1 value='<%= f21_5 %>'><br>
<label><script>w1('GUARCOKINDCODE')</script></label>
<input name='f296' style='width:40' qtype='3206' onpropertychange="getDesc()" pop="no" readonly tabindex=-1 value='<%= f96 %>'><input name='f296Lbl' style='width:250' readonly tabindex='-1' value='<%= f296Lbl %>'>
<label><script>w1('GUARCOMPCODE')</script></label>
<input name='f297' style='width:40' qtype='3207' onpropertychange="getDesc()" pop="no" readonly tabindex=-1 value='<%= f97 %>'><input name='f297Lbl' style='width:240' readonly tabindex='-1' value='<%= f297Lbl %>'><br>
...
<label style="width:136"><script>w1('CLASSTYP3')</script></label>
...
<!--<label><script>w1('LIMITTYPE')</script></label>-->
...
<input name='f3' style='width:150' value='<%= f6 %>' readonly tabindex='-1'>
<label style="margin-left:90"><script>w1('LONREQDT')</script></label><input name='f58' type='hidden' value='<%=f84%>' readonly tabindex='-1'>
<input name='f58_4' style='width:80' readonly tabindex='-1'><input name='f58' type='hidden' value='<%=f84%>' readonly tabindex='-1'>
...
<input name='f4' qtype='28' style="width:80" pop="no" value='<%= f26 %>' readonly tabindex='-1'><input name='f4Lbl' style="width:200" readonly tabindex='-1'>
<label style='margin-left:-40'><script>w1('MGREMPNM')</script></label>
<input name='f5' qtype='28' style="width:80" pop="no" value='<%= f27 %>' readonly tabindex='-1'><input name='f5Lbl' style="width:200" readonly tabindex='-1'><br>

<label style="margin-left:36"><script>w1('SGTPROPNO')</script></label>
<input name='f409' qtype='28' style="width:80" pop="no" value='<%= f409 %>' readonly tabindex='-1'><input name='f409Lbl' style="width:200" readonly tabindex='-1' value='<%= f409Lbl %>'><br>

<label style="margin-left:36"><script>w1('RELTCNSLNO')</script></label>
<input name='f435' style="width:140" value='<%= f435 %>' readonly tabindex='-1'>
<label style="margin-left:100"><script>w1('LONTOTAMT')</script></label>
<input name='f436' value='<%= f436 %>' readonly tabindex='-1' style='width:130'><br>

<label style="margin-left:36"><script>w1('LIFEINSUAMT3')</script></label>
<input name='f410' value='<%= f410 %>' readonly tabindex='-1' style='width:130'>
<label style="margin-left:110"><script>w1('LIFEINSUAMT4')</script></label>
<input name='f411' value='<%= f411 %>' readonly tabindex='-1' style='width:130'><br>

<label style="margin-left:36"><script>w1('GUARTYPE')</script></label>
<input name='f426' style="width:25" qtype="3306" master="f58" pop="no" readonly tabindex='-1' value='<%= f426 %>'><input name='f426Lbl' style="width:220" readonly tabindex='-1' value='<%= f426Lbl %>'><br>

<label><script>w1('FEEPATN1')</script></label>
<select name='f446' table="COMCOMB" key="5090" value='<%= f446 %>' disabled></select>
<label style="margin-left:128"><script>w1('FEEPATN2')</script></label>
...
<input type='hidden' name='f445_1' style="width:80" value='<%= f445_1 %>' readonly tabindex='-1'><input name='f445_2' style="width:80" value='<%= f445_2 %>' readonly tabindex='-1'>
...
<input name='f444_1' qtype='4084' style='width:36' maxlength='4' readonly onpropertychange="getBankName1();" value='<%= f444_1 %>' ><input name='f444_1Lbl' style='width:240' maxlength='30' readonly tabindex='-1' value='<%= f444_1Lbl %>' >

<!-- 支店 -->
<label style="margin-left:-40"><script>w1('NBR')</script></label>
<input name='f444_2' qtype='4085' style='width:36' maxlength='4' master="f444_1" readonly onpropertychange="getShitenName1();" value='<%= f444_2 %>'><input name='f444_2Lbl' style='width:240' readonly tabindex='-1' value='<%= f444_2Lbl %>'><br>

<!-- 種別 -->
<label style="margin-left:36"><script>w1('KIND')</script></label>
<input name='f444_3' style='width:20' maxlength='2' qtype='3999' readonly onpropertyChange="getDesc()" value='<%= f444_3 %>'><input name='f444_3Lbl' style='width:90' readonly tabindex='-1' value='<%= f444_3Lbl %>'>

<!-- 口座番号 -->
<label style="margin-left:130"><script>w1('DEP_ACCT_NO')</script></label><input name='f444_4' style='width:160' readonly maxlength='20' value='<%= f444_4 %>'><br>

<!-- 20200331 Ek Edit Start -->
<!-- 引落名義(カナ) -->
<label style="margin-left:40"><script>w1('DEP_ACCT_NAME_KANA')</script></label></label><input name='f461' style='width:400' readonly maxlength='80' value='<%= f461 %>'>
<br><br>
...
<!-- 銀行 -->
<label style="margin-left:36"><script>w1('BANK')</script></label>
<input name='f508_1' qtype='4084' style='width:36' maxlength='4' readonly onpropertychange="getBankName2();"  value='<%= f508_1 %>'><input name='f508_1Lbl' style='width:240' maxlength='30' readonly tabindex='-1' value='<%= f508_1Lbl %>' >

<!-- 支店 -->
<label style="margin-left:-40"><script>w1('NBR')</script></label>
<input name='f508_2' qtype='4085' style='width:36' maxlength='4' readonly master="f508_1" onpropertychange="getShitenName2();" value='<%= f508_2 %>'><input name='f508_2Lbl' style='width:240' readonly tabindex='-1' value='<%= f508_2Lbl %>'><br>

<!-- 種別 -->
<label style="margin-left:36"><script>w1('KIND')</script></label>
<input name='f508_3' style='width:20' maxlength='2' qtype='3999' readonly onpropertyChange="getDesc()" value='<%= f508_3 %>'><input name='f508_3Lbl' style='width:90' readonly tabindex='-1' value='<%= f508_3Lbl %>'>

<!-- 口座番号 -->
<label style="margin-left:130"><script>w1('DEP_ACCT_NO')</script></label><input name='f508_4' style='width:160' readonly maxlength='20' value='<%= f508_4 %>'><br>

<!-- 口座名義(カナ) -->
<label style="margin-left:40"><script>w1('DEPACCTNAME')</script></label></label><input name='f509' style='width:400' readonly maxlength='60' value='<%= f509 %>'>
<br><br>

<label style="margin-left:36"><script>w1('LOANISSUMETHOD')</script></label>
<input name='f6' qtype='3210' style="width:25" onpropertychange="show();getDesc();" pop="no" value='<%= f28 %>' readonly tabindex='-1'><input name='f6Lbl' style="width:160" readonly tabindex='-1' value='<%= f6Lbl %>'><br>
...
<span id='d2' style="display:none">
	...
	<input name='f413_3' style='width:80' maxlength='10'  readonly tabIndex='-1' value='<%= f413_3 %>'><input name='f413' style='width:400' maxlength='30' readonly tabindex='-1'>
	...
	<input name='f414' style='width:30'  readonly tabIndex='-1' value='<%= f414 %>'>%<br>

	<label style="margin-left:36"><script>w1('JOINJOINCIF2')</script></label>
	<input name='f415_3' style='width:80' maxlength='10'  readonly tabIndex='-1' value='<%= f415_3 %>'><input name='f415' style='width:400' maxlength='30' readonly tabindex='-1'>
	...
	<input name='f416' style='width:30'  readonly tabIndex='-1' value='<%= f416 %>'>%<br>

	<label style="margin-left:36"><script>w1('JOINJOINCIF3')</script></label>
	<input name='f417_3' style='width:80' maxlength='10'  readonly tabIndex='-1' value='<%= f417_3 %>'><input name='f417' style='width:400' maxlength='30' readonly tabindex='-1'>
	...
	<input name='f418' style='width:30'  readonly tabIndex='-1' value='<%= f418 %>'>%<br>

	<label style="margin-left:36"><script>w1('JOINJOINCIF4')</script></label>
	<input name='f419_3' style='width:80' maxlength='10'  readonly tabIndex='-1' value='<%= f419_3 %>'><input name='f419' style='width:400' maxlength='30' readonly tabindex='-1'>
	...
	<input name='f420' style='width:30'  readonly tabIndex='-1' value='<%= f420 %>'>%<br>
</span>
<span id='d' style="display:none">
	...
	<input name='f59' style='width:25'  maxlength='1' value='<%= f85 %>'   readonly tabIndex='-1'>
	...
	<input style="margin-left:205" name='f60_1' style='width:40' value='<%= f86_1 %>' readonly tabindex=-1><input name='f60_2' style='width:25' value='<%= f86_2 %>' readonly tabindex=-1><input name='f60_3' style='width:25' value='<%= f86_3 %>' readonly tabindex=-1><input  style="margin-left:50" name='f421' style='width:150' value='<%= f421 %>' readonly tabindex='-1'><br>
	<input style="margin-left:205" name='f61_1' style='width:40' value='<%= f87_1 %>' readonly tabindex=-1><input name='f61_2' style='width:25' value='<%= f87_2 %>' readonly tabindex=-1><input name='f61_3' style='width:25' value='<%= f87_3 %>' readonly tabindex=-1><input  style="margin-left:50" name='f422' style='width:150' value='<%= f422 %>' readonly tabindex='-1'><br>
	<input style="margin-left:205" name='f62_1' style='width:40' value='<%= f88_1 %>' readonly tabindex=-1><input name='f62_2' style='width:25' value='<%= f88_2 %>' readonly tabindex=-1><input name='f62_3' style='width:25' value='<%= f88_3 %>' readonly tabindex=-1><input  style="margin-left:50" name='f423' style='width:150' value='<%= f423 %>' readonly tabindex='-1'><br>
	<input style="margin-left:205" name='f63_1' style='width:40' value='<%= f89_1 %>' readonly tabindex=-1><input name='f63_2' style='width:25' value='<%= f89_2 %>' readonly tabindex=-1><input name='f63_3' style='width:25' value='<%= f89_3 %>' readonly tabindex=-1><input  style="margin-left:50" name='f424' style='width:150' value='<%= f424 %>' readonly tabindex='-1'><br>
	<input style="margin-left:205" name='f64_1' style='width:40' value='<%= f90_1 %>' readonly tabindex=-1><input name='f64_2' style='width:25' value='<%= f90_2 %>' readonly tabindex=-1><input name='f64_3' style='width:25' value='<%= f90_3 %>' readonly tabindex=-1><input  style="margin-left:50" name='f425' style='width:150' value='<%= f425 %>' readonly tabindex='-1'><br>
</span>
...
<input name='f44' style="width:30" readonly tabindex='-1'  value='<%= f67 %>' readonly tabindex='-1'><input name='f44Lbl' style="width:400" readonly tabindex='-1' value='<%= f448 %>'><br>
<label><script>w1('CAPTPAYBKMTHD')</script></label>
<select name='f45' table="LNPCODE" key="507" disabled></select>
<label style="width:216"><script>w1('INTPAYBKMTHD')</script></label>
...
<label style='margin-left:114'><script>w1('INTPAYBKCYCL')</script></label>
...
<input name='stepFlag' type='hidden' style='margin-left:-4' disabled><!--STEP適用区分--><br>

<label><script>w1('BNSREPAYAMT')</script></label>
<input name='f50' style='width:150' value='<%= f75 %>' readonly tabindex='-1'>
<label style='margin-left:90' ><script>w1('BNSREPAYMON')</script></label>
<input name='f51' style='width:20' value='<%= f76 %>' readonly tabindex='-1'>,<input name='f52' style='width:20' value='<%= f77 %>' readonly tabindex='-1'><br>

<label><script>w1('EACHPARTAMT')</script></label>
<input name='f53' style='width:150' value='<%= f79 %>' readonly tabindex='-1'>
<label style='margin-left:90' ><script>w1('BNSEACHPARTAMT')</script></label>
<input name='f54' style='width:150' value='<%= f80 %>' readonly tabindex='-1'><br>

<label><script>w1('AMTAPPLTERM')</script></label>
<input name='f150' style="width:30" value='<%= f150 %>' readonly tabindex='-1'><br><br>
...
<input name='d35' style='width:80' readonly tabindex='-1'>
<input name='f35_1' type='hidden' style='width:40' value='<%= f57_1 %>'><input name='f35_2' type='hidden' style='width:20' value='<%= f57_2 %>'><input name='f35_3' type='hidden' style='width:20' value='<%= f57_3 %>'>
<label><script>w1('RIMBMNS')</script></label>
<input name='f36' style='width:30' value='<%= f58 %>' readonly tabindex='-1'><input type='hidden' name='f37' style='width:80' value='<%= f59 %>' readonly tabindex='-1'><br>
...
<input name='d39' style='width:80' readonly tabindex='-1'>
<input name='f39_1' type='hidden' style='width:40' value='<%= f61_1 %>'><input name='f39_2' type='hidden' style='width:20' value='<%= f61_2 %>'><input name='f39_3' type='hidden' style='width:20' value='<%= f61_3 %>'>
<label><script>w1('EXPMTHS')</script></label>
<input name='f40' style='width:30' value='<%= f62 %>' readonly tabindex='-1'><input type='hidden' name='f41' style='width:80' value='<%= f63 %>' readonly tabindex='-1'><br>

<label><script>w1('THEDATE')</script></label>
<input name='f42' style='width:25' value='<%= f64 %>' readonly tabindex='-1'><br>
<input name='f43' type='hidden' value='<%= f66 %>' readonly tabindex='-1'><br><!--振込猶予区分-->

<label><script>w1('REPAYFUND')</script></label>
<input name='f55' style='width:360' value='<%= f81 %>' readonly tabindex='-1'><br>
<label><script>w1('RIMBMTHD')</script></label>
<input name='f56' style='width:360' value='<%= f82 %>' readonly tabindex='-1'><br>
<label><script>w1('EXPECEFF')</script></label>
<input name='f57' style='width:360' value='<%= f83 %>' readonly tabindex='-1'><br>
</p>
...
<select name='f9'  table="LNPCODE" key="607" disabled='true' style='width:250'></select>
<label><script>w1('BASERATECODE')</script></label>
<select name='f10' table="LNPCODE" key="608" disabled='true' style='width:250'></select><br>
<label><script>w1('CAPSELECTTERM')</script></label>
<input name='f11' qtype="8001" f3ESC='Y' master="211" master2="f9" master3="f10" master4="ichaMonth" master5="glDay" pop="no" style="width:30" value='<%= f33 %>' readonly tabindex='-1'><!--cal8()-->
<label style="margin-left:220"><script>w1('FIXRATESPCTYP')</script></label>
<input name='f12' style='width:30' qtype="7001" f3ESC='Y' master="211" master2="f9" master3="f10" master4="ichaMonth" master5="glDay" pop="no" value='<%= f34 %>' readonly tabindex='-1'><!--cal7()--><br>
<label><script>w1('NEXTCHPCODE')</script></label>
<select name='f13'  table="LNPCODE" key="607" disabled='true' style='width:250'></select>
<label><script>w1('NEXTBASERATECODE')</script></label>
<select name='f14' table="LNPCODE" key="608" disabled='true' style='width:250'></select><br>
<label><script>w1('SPECCODE')</script></label>
<input name='f503' f3ESC='Y' disabled='true' style='width:30' value='<%= f503 %>'><input name='f503Lbl' disabled='true' style='width:220' readonly tabindex='-1' value='<%= f458 %>'>
<label><script>w1('LIFEINSUAMT5')</script></label>
<input name='f504' disabled='true' style='width:130' value='<%= f504 %>'><br>
<!--label><script>w1('NEXTSPECTERM')</script></label-->
<input name='f15' style='width:30' type="hidden" value='<%= f37 %>'>
<!--変動類型PLAN-->
<input name='f453' type='hidden' style='width:30' qtype="3307" f3ESC='Y' pop="no" value='<%= f453 %>'><input name='f453Lbl' type='hidden' style='width:160' readonly tabindex='-1' value='<%= f455 %>'>
<!--基準利率PLAN-->
<input name='f454' type='hidden' style='width:30' qtype="3305" f3ESC='Y' pop="no" value='<%= f454 %>'><input name='f454Lbl' style='width:160' type='hidden' readonly tabindex='-1' value='<%= f456 %>'><br><br>

<label><script>w1('GRPRATEINFO')</script></label><br>
<label><script>w1('PRIMERATE')</script></label>
<input name='f16' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding();" value='<%= f38 %>'>
<label><script>w1('PLUSRATE')</script></label>
<input name='f18' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f40 %>'>
<label><script>w1('MINUSRATE')</script></label>
<input name='f19' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f41 %>'><br>
<label><script>w1('FSTGRADRATE')</script></label>
<input name='f20' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f42 %>'>
<label><script>w1('FSTSPREADRATE')</script></label>
<input name='f21' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f43 %>'>
<label><script>w1('GRPRATE')</script></label>
<input name='f17' style='width:80' onpropertychange="u_autopadding()" readonly tabindex='-1' value='<%= f39 %>'><br>
<label><script>w1('CAP')</script></label>
<input name='f22' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f44 %>'>
<label><script>w1('FLOOR')</script></label>
<input name='f23' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f45 %>'>
<label><script>w1('NEXTSPREADRATE')</script></label>
<input name='f24' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f46 %>'><br>
<label><script>w1('TERMRATE')</script></label>
<input name='f25' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f47 %>'>
<label><script>w1('CAPTERMSPREADRATE')</script></label>
<input name='f26' style='width:80' onpropertychange="u_autopadding()" readonly tabindex='-1' value='<%= f48 %>'>
<label><script>w1('PRODFIXRATE')</script></label>
<input name='f438' style='width:80; textAlign:right' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f438 %>'><br>
<label><script>w1('CIFCAP')</script></label>
<input name='f441' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f441 %>'><br><br>

<label><script>w1('FIXRATE')</script></label>
<input name='f27' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f49 %>'>
<label><script>w1('INCRS')</script></label>
<input name='f28' style='width:80' onpropertychange="u_autopadding()" value='<%= f50 %>' readonly tabindex='-1'>
<label><script>w1('PDCRS')</script></label>
<input name='f29' style='width:80' onpropertychange="u_autopadding()" value='<%= f51 %>' readonly tabindex='-1'><br>

<label><script>w1('SUPPRATE')</script></label>
<input name='DEPRATE' style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f111 %>'>
<label><script>w1('GUARRATE')</script></label>
<input name='f401' style='width:80' onpropertychange="u_autopadding()"  value='<%= f401 %>' readonly tabindex='-1'>
<label><script>w1('CORPLIFERATE')</script></label>
<input name='f402' style='width:80'  onpropertychange="u_autopadding()" value='<%= f402 %>' readonly tabindex='-1'><br>
<label><script>w1('SPECADDRATE')</script></label>
<input name='f505' style='width:80' onpropertychange="u_autopadding()" value='<%= f505 %>'readonly tabindex='-1'>
<label><script>w1('DEPRATE')</script></label>
<input name='f30' style='width:80' onpropertychange="u_autopadding()" value='<%= f52 %>' readonly tabindex='-1'>
<label><script>w1('TRFMAGRATE')</script></label>
<input name='f33' style='width:80' onpropertychange="u_autopadding()" value='<%= f55 %>' readonly tabindex='-1'><br>
...
<input name='f32' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f54 %>'>
</p>
...
<input name='f408'style='width:45' readonly tabindex='-1' value='<%= f408 %>'><input name='f408Lbl' style='width:200' readonly tabindex='-1' value='<%= f408Lbl %>'>
<label><script>w1('INSTNO')</script></label>
<input name='f407'style='width:45' readonly tabindex='-1' value='<%= f407 %>'><input name='f407Lbl' style='width:200' readonly tabindex='-1' value='<%= f407Lbl %>'><br>
<label style="margin-left:17"><script>w1('PRIPATTERN')</script></label>
<input name='f408_1' style='width:45' qtype='80' pop='no' f3ESC='Y' readonly tabindex='-1' value='<%= f500 %>'><input name='f408_1Lbl' style='width:200' readonly tabindex='-1' value='<%= f500Lbl %>'><br>
...
<input name='f31' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f53 %>'><br>
...
<input name='f439' style='width:80' onpropertychange="u_autopadding()" readonly tabindex=-1 value='<%= f439 %>'><br>
<label style="margin-left:17"><script>w1('MAXPRIVRATE')</script></label>
<input name='f406'  style='width:80' readonly tabindex='-1' value='<%= f406 %>'>
<label style="margin-left:167"><script>w1('APLPRIVRATE')</script></label>
<input name='f440' style='width:80' readonly tabindex='-1' onpropertychange="u_autopadding()" value='<%= f440 %>'><br><br>

<span style="overflow:auto; width:100%; height:300; border:none">
...
<input name='f151' style='width:80' onblur='u_autopadding()' value='<%= f151 %>' readonly tabindex='-1'>%<br>
...
<%	} else {
	...
	<tr bgcolor='white' align='center'>
    	...
    	<td id="td154"><input name='f154' class='xInput' style='width:170;text-align:right' value='<%= f154[i] %>' mask='02' iLen=15 fLen=0 readonly tabindex='-1'></td>
	</tr>
<% 		}
	}
%>
...
<input name='f601' style='width:150;text-align:right' onpropertychange='u_moveValue()' value='<%= f601 %>' readonly tabindex='-1'><br>
<!-- 印紙代 -->
<label style='margin-left:20'><script>w1('STAMPTAX')</script></label>
<input name='f602' style='width:150;text-align:right' onpropertychange='u_moveValue()' value='<%= f602 %>' readonly tabindex='-1'><br>
<!-- 公証費用 -->
<label style='margin-left:20'><script>w1('KJFEE')</script></label>
<input name='f603' style='width:150;text-align:right' onpropertychange='u_moveValue()' value='<%= f603 %>' readonly tabindex='-1'><br>
<!-- 火災保険料 -->
<label style='margin-left:20'><script>w1('INSUFEE')</script></label>
<input name='f604' style='width:150;text-align:right' onpropertychange='u_moveValue()' value='<%= f604 %>' readonly tabindex='-1'><br>
<!-- 担保調査費用 -->
<label style='margin-left:20'><script>w1('OUTCOLLRESFEE')</script></label>
<input name='f605' style='width:150;text-align:right' onpropertychange='u_moveValue()' value='<%= f605 %>' readonly tabindex='-1'><br>
<!-- 確定日付料 -->
<label style='margin-left:20'><script>w1('FIXDATEFEE')</script></label>
<input name='f606' style='width:150;text-align:right' onpropertychange='u_moveValue()' value='<%= f606 %>' readonly tabindex='-1'><br>
<!-- 登記費用 -->
<label style='margin-left:20'><script>w1('DKFEE')</script></label>
<input name='f607' style='width:150;text-align:right' onpropertychange="u_moveValue()" value='<%= f607 %>' readonly tabindex='-1'><br>
<!-- 差引後顧客口座入金金額 -->
<label style='margin-left:3'><script>w1('NETDEPTOTAMT')</script></label>
<input name='f608' style='width:150;text-align:right' readonly tabindex='-1'>
