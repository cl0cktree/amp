...
//			document.all.f42.tabIndex = 0;
	...
	function cal14(){
		...
		if(event.srcElement.value == ""){
			...
			var res = parse(event.srcElement.value);
			if(res > 6){
				document.all.f52.value = "";
			}else{
...
<input type='hidden' name='f1_1' value='<%= f4_1 %>'><input name='f1_2' style='width:40' readonly tabindex='-1' value='<%= f4_2 %>'><input name='f1_3' style='width:40' readonly tabindex='-1' value='<%= f4_3 %>'><input name='f1_4' style='width:20' readonly tabindex='-1' value='<%= f4_4 %>'><input name='f1_5' style='width:60' readonly tabindex='-1' value='<%= f4_5 %>'>
<label><script>w1('CURRENCYCD')</script></label> <input name='f100'  style='width:40' readonly ></input><br> <!--20160321fx add ---->
<input type='hidden' name='h1_1' value='<%= f4_1 %>'><input type='hidden' name='h1_2' value='<%= f4_2 %>'><input type='hidden' name='h1_3' style='width:40' value='<%= f4_3 %>'><input type='hidden' name='h1_4' style='width:20' value='<%= f4_4 %>'><input type='hidden' name='h1_5' style='width:60' value='<%= f4_5 %>'>
<label><script>w1('CIF')</script></label>
<input type='hidden' name='CIF_1' readonly tabindex=-1 value='<%= f9_1 %>'><input type='hidden' name='CIF_2' style='width:40' readonly tabindex=-1 value='<%= f9_2 %>'><input name='CIF_3' style='width:80' readonly tabindex=-1 value='<%= f9_3 %>'><input name='CIFNAME' style='width:600' readonly tabindex=-1 value='<%= f10 %>'><br>
...
<label><script>w1('LONSTATUS')</script></label>
<input name='f206' style='width:150' readonly tabindex=-1 value='<%= f7 %>'><br>

<input type='hidden' name='f209' style='width:360' readonly tabindex=-1 value='<%= f11 %>'>
<label><script>w1('COMPTYPNAM')</script></label>
<input name='f210' style='width:40' qtype="61" onpropertychange="getDesc()" readonly tabindex=-1 pop="no" value='<%= f12 %>'><input name='f210Lbl' style='width:360' readonly tabindex=-1><br>

<label><script>w1('PRODCD')</script></label><input name='f211' type='hidden' value='<%= f13 %>'>
<input name='f211_1' style='width:110' readonly tabindex=-1 value='<%= ProductCode(f13) %>'><input name='f212' style='width:420' readonly tabindex=-1 value='<%= f14 %>'><br>

<label><script>w1('FUNDUSECD')</script></label>
<input name='f213' style='width:40' readonly tabindex=-1 value='<%= f15 %>'><input name='f501' style='width:350' readonly tabindex='-1' value='<%= f501 %>'><br>

<label><script>w1('CNSLKIND')</script></label>
<select name='f217' table='LNPCODE' key='634' disabled></select>
<label style='width:305'><script>w1('LIMITKIND')</script></label>
<select name='f218' table='LNPCODE' key='632' disabled></select><br>

<label><script>w1('COLLKIND')</script></label>
<select name='f219' table='LNPCODE' key='23' disabled style='width:290'></select>
<label><script>w1('GUARNTTYP')</script></label>
<input name='f220' style='width:40' onpropertychange="u_getGuarKind(this.value)" readonly tabindex=-1 value='<%= f19 %>'><input name='f220Lbl' style='width:240' readonly tabindex='-1'><br>

<label><script>w1('BILLCNLTKIND')</script></label>
<select name='f221' table='LNPCODE' key='633' disabled></select>
<label style='width:292'><script>w1('ACCTABOUTBILLLOAN')</script></label>
<input type='hidden' name='f222_1' readonly tabindex=-1 value='<%= f21_1 %>'><input type='hidden' name='f222_2' readonly tabindex=-1 value='<%= f21_2 %>'><input name='f222_3' style='width:40' readonly tabindex=-1 value='<%= f21_3 %>'><input name='f222_4' style='width:25' readonly tabindex=-1 value='<%= f21_4 %>'><input name='f222_5' style='width:60' readonly tabindex=-1 value='<%= f21_5 %>'><br>

<label><script>w1('GUARCOKINDCODE')</script></label>
<input name='f296' style='width:40' qtype='3206' onpropertychange="getDesc()" readonly tabindex=-1 pop='no' value='<%= f96 %>'><input name='f296Lbl' style='width:250' readonly tabindex='-1' value='<%= f296Lbl %>'>
<label><script>w1('GUARCOMPCODE')</script></label>
<input name='f297' style='width:40' qtype='3207' onpropertychange="getDesc()" readonly tabindex=-1 pop='no' value='<%= f97 %>'><input name='f297Lbl' style='width:240' readonly tabindex='-1' value='<%= f297Lbl %>'><br>

<label><script>w1('GROUPLIFECODE')</script></label>
<input name='f223' style='width:40' readonly tabindex=-1  qtype='3154' pop='no' value='<%= f22 %>'><input name='f502' style='width:250' readonly tabindex='-1' value='<%= f502 %>'>
<label><script>w1('LIFECNT')</script></label>
<input name='f224' style='width:40' readonly tabindex=-1 value='<%= f23 %>'><br>

<label><script>w1('LOANENTERFLAG')</script></label>
<input type="checkbox" name='f225' style="margin-left:-4" value='<%= f24 %>'  <%=f24.trim().equals("y") ? "checked" : "" %>>
<label style='margin-left:-35'><script>w1('CKECKYN')</script></label>
<label style='margin-left:185'><script>w1('LOANINSLNO')</script></label>
<input name='f226' style='width:150' readonly tabindex=-1 value='<%= f25 %>'><br>
...
<label><script>w1('DEBTKIND')</script></label>
<select name='f300' table="LNPCODE" key="609" disabled ></select>
<label style="width:135"><script>w1('CLASSTYP3')</script></label>
<select name='f301' table="LNPCODE" key="610" disabled ></select><br>
<label><script>w1('CREDITKIND')</script></label>
<select name='f303' table="LNPCODE" key="611" disabled ></select>
<label><script>w1('TREATPLAN')</script></label>
<select name='f304' table="LNPCODE" key="612" disabled ></select><br>
<label><script>w1('SUMMARY')</script></label>
<input name='f308' style='width:460' readonly tabindex=-1 value='<%= f106 %>'><br>
<label>&nbsp;</label>
<input name='f309' style='width:460' readonly tabindex=-1 value='<%= f107 %>'><br>
<label>&nbsp;</label>
<input name='f310' style='width:460' readonly tabindex=-1 value='<%= f108 %>'><br>
<label>&nbsp;</label>
<input name='f311' style='width:460' readonly tabindex=-1 value='<%= f109 %>'><br>
</p>
...
<label style="margin-left:36"><script>w1('WANAPPLAMT')</script></label>
<input name='f3' style='width:150' onpropertychange='u_moveValue()'
onblur="u_autoPadding()" value='<%= f6 %>'> <!--  20160321---------->

<label style="margin-left:90"><script>w1('LONREQDT')</script></label>
<input name='f58_1' style='width:40'><input name='f58_2' style='width:25'><input name='f58_3' style='width:25'>
<input name='f58' type='hidden'><br>

<label style="margin-left:36"><script>w1('SOLIEMPNO')</script></label>
<input name='f4' qtype='28' style="width:80" maxlength='10' value='<%= f26 %>'><input name='f4Lbl' style="width:200" readonly tabindex=-1>
<label style='margin-left:-40'><script>w1('MGREMPNM')</script></label>
<input name='f5' qtype='28' style="width:80" maxlength='10' value='<%= f27 %>'><input name='f5Lbl' style="width:200" readonly tabindex=-1><br>

<label style="margin-left:36"><script>w1('SGTPROPNO')</script></label>
<input name='f409' qtype='28' style="width:80" maxlength='10' pop='no' readonly tabindex='-1' value='<%= f409 %>'><input name='f409Lbl' style="width:200" readonly tabindex=-1 value='<%= f409Lbl %>'><br>

<label style="margin-left:36"><script>w1('RELTCNSLNO')</script></label>
<input name='f435_1' style="width:140" readonly tabindex=-1><input name='f435' type='hidden' style="width:140" readonly tabindex=-1 value='<%= f435 %>'>
<label style="margin-left:100"><script>w1('LONTOTAMT')</script></label>
<input name='f436' style='width:130' readonly tabindex='-1' value='<%= f436 %>'><br>

<label style="margin-left:36"><script>w1('LIFEINSUAMT3')</script></label>
<input name='f410' style='width:130' value='<%= f410 %>'>
<label style="margin-left:110"><script>w1('LIFEINSUAMT4')</script></label>
<input name='f411' style='width:130' value='<%= f411 %>'><br>

<label style="margin-left:36"><script>w1('GUARTYPE')</script></label>
<input name='f426' style="width:25" qtype="3400" master="f297" master2="execday" onpropertychange='localQuery2()' value='<%= f426 %>'><input name='f426Lbl' style="width:220" readonly tabindex=-1 value='<%= f426Lbl %>'><br>

<!---- 2021/07/14 ORIX DEMO ebs START
<label><script>w1('FEEPATN1')</script></label>
<select name='f446' table="COMCOMB" key="5090" value='<%= f446 %>'></select>
<label style="margin-left:136"><script>w1('FEEPATN2')</script></label>
...
<label style="margin-left:36"><script>w1('OUTACCT_CIF')</script></label>
<input name='f445_1' type='hidden' value='<%= f445_1 %>'><input name='f445_3' type='hidden' value='<%= f445_3 %>'><input name='f445_2' style="width:80" value='<%= f445_2 %>' onpropertychange='u_reqcheck()'>

<br><br>
<!-- 引落口座情報 -->
<label style="margin-left:36"><script>w1('DEPACCT_INFO')</script></label><br>
<!-- 銀行 -->
<label style="margin-left:36"><script>w1('BANK')</script></label>
<input name='f444_1' qtype='4084' style='width:36' maxlength='4' onpropertychange="getBankName1();" value='<%= f444_1 %>' ><input name='f444_1Lbl' style='width:240' maxlength='30' readonly tabindex='-1' value='<%= f444_1Lbl %>' >

<!-- 支店 -->
<label style="margin-left:-40"><script>w1('NBR')</script></label>
<input name='f444_2' qtype='4085' style='width:36' maxlength='4' master="f444_1" onpropertychange="getShitenName1();" value='<%= f444_2 %>'><input name='f444_2Lbl' style='width:240' readonly tabindex='-1' value='<%= f444_2Lbl %>'><br>

<!-- 種別-->
<label style="margin-left:36"><script>w1('KIND')</script></label>
<input name='f444_3' style='width:20' maxlength='2' qtype='3999' onpropertyChange="getDesc()" value='<%= f444_3 %>'><input name='f444_3Lbl' style='width:90' readonly tabindex='-1' value='<%= f444_3Lbl %>'>

<!-- 口座番号 -->
<label style="margin-left:130"><script>w1('DEP_ACCT_NO')</script></label><input name='f444_4' style='width:160' maxlength='7' value='<%= f444_4 %>'><br>

<!-- 20200331 Ek Edit Start -->
<!-- 引落名義(カナ) -->
<label style="margin-left:40"><script>w1('DEP_ACCT_NAME_KANA')</script></label></label><input name='f461' style='width:450' maxlength='30' value='<%= f461 %>'>
<br><br>
<!-- 20200331 Ek Edit End -->

<!-- 入金（振込先）口座情報 -->
<label style="margin-left:36"><script>w1('TRFACCT_INFO')</script></label><br>
<!-- 銀行 -->
<label style="margin-left:36"><script>w1('BANK')</script></label>
<input name='f508_1' qtype='4084' style='width:36' maxlength='4' onpropertychange="getBankName2();"  value='<%= f508_1 %>'><input name='f508_1Lbl' style='width:240' maxlength='30' readonly tabindex='-1' value='<%= f508_1Lbl %>' >

<!-- 支店 -->
<label style="margin-left:-40"><script>w1('NBR')</script></label>
<input name='f508_2' qtype='4085' style='width:36' maxlength='4' master="f508_1" onpropertychange="getShitenName2();" value='<%= f508_2 %>'><input name='f508_2Lbl' style='width:240' readonly tabindex='-1' value='<%= f508_2Lbl %>'><br>

<!-- 種別 -->
<label style="margin-left:36"><script>w1('KIND')</script></label>
<input name='f508_3' style='width:20' maxlength='2' qtype='3999' onpropertyChange="getDesc()" value='<%= f508_3 %>'><input name='f508_3Lbl' style='width:90' readonly tabindex='-1' value='<%= f508_3Lbl %>'>

<!-- 口座番号 -->
<label style="margin-left:130"><script>w1('DEP_ACCT_NO')</script></label><input name='f508_4' style='width:160' maxlength='7' value='<%= f508_4 %>'><br>

<!-- 口座名義(カナ) -->
<label style="margin-left:40"><script>w1('DEPACCTNAME')</script></label></label><input name='f509' style='width:450' maxlength='30' value='<%= f509 %>'>
<br><br>


<label style="margin-left:36"><script>w1('LOANISSUMETHOD')</script></label>
<input name='f6' style="width:25" qtype='3210' onpropertychange="show()" onblur="u_autotwo(this.value)" value='<%= f28 %>'><input name='f6Lbl' style="width:160" readonly tabindex=-1 value='<%= f6Lbl %>'><br>

<label style="margin-left:36"><script>w1('RELDEBTKIND')</script></label>
<select name='f412' table='LNPCODE' key='720' onpropertychange="show2()" value='<%= f412 %>'><select>
<label style='margin-left:149'><script>w1('JOINDEBTRATE')</script></label>
<input name='p906' style='width:30' readonly tabIndex='-1'>%
<input type='hidden' name='f7' value='<%= f29 %>'><!--限度区分--><br>

<span id='d2' style="display:none"><!--show2()-->
	<label style="margin-left:36"><script>w1('JOINJOINCIF1')</script></label>
	<input name='f413_3' style='width:80' onpropertychange="doCheckInputFields(this);" value='<%= f413_3 %>'><input name='ciff413' style='width:400' maxlength='30' readonly tabindex='-1'>
	<input name='f413_1' type='hidden' value='<%= f413_1 %>'><input name='f413_2' type='hidden' value='<%= f413_2 %>'>
	<label style='margin-left:-45'><script>w1('JOINRATET1')</script></label>
	<input name='f414' style='width:30' onblur="u_joinChange('p906','f414','f416','f418','f420','f412')" value='<%= f414 %>'>%<br>

	<label style="margin-left:36"><script>w1('JOINJOINCIF2')</script></label>
	<input name='f415_3' style='width:80' onpropertychange="doCheckInputFields(this);" value='<%= f415_3 %>'><input name='ciff415' style='width:400' maxlength='30' readonly tabindex='-1'>
	<input name='f415_1' type='hidden' value='<%= f415_1 %>'><input name='f415_2' type='hidden' value='<%= f415_2 %>'>
	<label style='margin-left:-45'><script>w1('JOINRATE2')</script></label>
	<input name='f416' style='width:30' onblur="u_joinChange('p906','f414','f416','f418','f420','f412')" value='<%= f416 %>'>%<br>

	<label style="margin-left:36"><script>w1('JOINJOINCIF3')</script></label>
	<input name='f417_3' style='width:80' onpropertychange="doCheckInputFields(this);" value='<%= f417_3 %>'><input name='ciff417' style='width:400' maxlength='30' readonly tabindex='-1'>
	<input name='f417_1' type='hidden' value='<%= f417_1 %>'><input name='f417_2' type='hidden' value='<%= f417_2 %>'>
	<label style='margin-left:-45'><script>w1('JOINRATE3')</script></label>
	<input name='f418' style='width:30' onblur="u_joinChange('p906','f414','f416','f418','f420','f412')" value='<%= f418 %>'>%<br>

	<label style="margin-left:36"><script>w1('JOINJOINCIF4')</script></label>
	<input name='f419_3' style='width:80' onpropertychange="doCheckInputFields(this);" value='<%= f419_3 %>'><input name='ciff419' style='width:400' maxlength='30' readonly tabindex='-1'>
	<input name='f419_1' type='hidden' value='<%= f419_1 %>'><input name='f419_2' type='hidden' value='<%= f419_2 %>'>
	<label style='margin-left:-45'><script>w1('JOINRATE4')</script></label>
	<input name='f420' style='width:30' onblur="u_joinChange('p906','f414','f416','f418','f420','f412')" value='<%= f420 %>'>%<br>
	<button style='margin-left:165' onClick="u_searchCIF('f413','f415','f417','f419')" id=cifsearch><script>w1('QUERY')</script></button>
</span>
<span id='d' style="display:none"><!--show()-->
	<br><b><label style="margin-left:36"><script>w1('DIVISSUSCHEINFO')</script></label></b><br>

	<label style="margin-left:36"><script>w1('DIVISSUSCHECNT')</script></label>
	<input name='f59' style='width:25' maxlength=1 onblur="u_divissu()" value='<%= f85 %>'>
	<label style="margin-left:-17"><script>w1('SCHEDATE')</script></label><label style="margin-left:5"><script>w1('SCHEAMT')</script></label><br>

	<input style="margin-left:205" name='f60_1' style='width:40' disabled=true value='<%= f86_1 %>'><input name='f60_2' style='width:25' disabled=true value='<%= f86_2 %>'><input name='f60_3' style='width:25' disabled=true value='<%= f86_3 %>'><input  style="margin-left:50" name='f421' style='width:150' disabled=true value='<%= f421 %>' onblur="u_autoPadding()"><br>
	<input style="margin-left:205" name='f61_1' style='width:40' disabled=true value='<%= f87_1 %>'><input name='f61_2' style='width:25' disabled=true value='<%= f87_2 %>'><input name='f61_3' style='width:25' disabled=true value='<%= f87_3 %>'><input  style="margin-left:50" name='f422' style='width:150' disabled=true value='<%= f422 %>' onblur="u_autoPadding()" ><br>
	<input style="margin-left:205" name='f62_1' style='width:40' disabled=true value='<%= f88_1 %>'><input name='f62_2' style='width:25' disabled=true value='<%= f88_2 %>'><input name='f62_3' style='width:25' disabled=true value='<%= f88_3 %>'><input  style="margin-left:50" name='f423' style='width:150' disabled=true value='<%= f423 %>' onblur="u_autoPadding()"><br>
	<input style="margin-left:205" name='f63_1' style='width:40' disabled=true value='<%= f89_1 %>'><input name='f63_2' style='width:25' disabled=true value='<%= f89_2 %>'><input name='f63_3' style='width:25' disabled=true value='<%= f89_3 %>'><input  style="margin-left:50" name='f424' style='width:150' disabled=true value='<%= f424 %>' onblur="u_autoPadding()" ><br>
	<input style="margin-left:205" name='f64_1' style='width:40' disabled=true value='<%= f90_1 %>'><input name='f64_2' style='width:25' disabled=true value='<%= f90_2 %>'><input name='f64_3' style='width:25' disabled=true value='<%= f90_3 %>'><input  style="margin-left:50" name='f425' style='width:150' disabled=true value='<%= f425 %>' onblur="u_autoPadding()" ><br>
</span>
...
<p id=tabPages class='TabPage'>
<!-- 返済方式コード -->
<label><script>w1('PAYBKMTHDCODE')</script></label>
<input name='f44' style="width:30" qtype="3301" master="f211"  onpropertychange="getCodes(this.value)" value='<%= f67 %>'><input name='f44Lbl' style="width:400" readonly tabindex=-1 value='<%= f448 %>'><br>
<!--元金返済方式-->
<label><script>w1('CAPTPAYBKMTHD')</script></label>
<select name='f45' table="LNPCODE" key="507"></select>
<!--利息返済方式-->
<label style="width:215"><script>w1('INTPAYBKMTHD')</script></label>
<select name='f46' table="LNPCODE" key="506"></select><br>
<!--元金返済周期-->
<label><script>w1('CAPTPAYBKCYCL')</script></label>
<input name='f47' style="width:25" qtype="3302" master="f44" onkeyup="label2();u_autoinit()" maxlength='2' value='<%= f70 %>'><input name='f47Lbl' style="width:160" readonly tabindex=-1 value='<%= f449 %>'>
<!--利息返済周期-->
<label style='margin-left:55'><script>w1('INTPAYBKCYCL')</script></label>
<input name='f48' style="width:25" qtype="3303" master="f47" master2="f44" onkeyup="label3();u_autoinit()" maxlength='2' value='<%= f71 %>'><input name='f48Lbl' style="width:160" readonly tabindex=-1 value='<%= f450 %>'><br>
<!--返済方式種類-->
<label><script>w1('CAPTPAYBKKIND')</script></label>
<select name='f460'  table="LNPCODE" key="721"></select><br>
<input name='f49' type='hidden' table='LNPCODE' key='604'><!--STEP種類-->
<input name='stepFlag' type='hidden' style='margin-left:-4' disabled><!--STEP適用区分-->
<!--ボーナス返済金額-->
<label><script>w1('BNSREPAYAMT')</script></label>

<input name='f50' style='width:130' onpropertychange="cal11()" onblur="u_autoPadding()" value='<%= f75 %>'>

<!--ボーナス月-->
<label style='margin-left:110'><script>w1('BNSREPAYMON')</script></label>
<input name='f51' style='width:20'  onfocus="cal12()" onpropertychange="cal14()">,<input name='f52' style='width:20' value='<%= f77 %>' readonly tabindex='-1'><br>
<!--毎回分割金-->
<label><script>w1('EACHPARTAMT')</script></label>
<input name='f53' style='width:130' value='<%= f79 %>'>
<!--ボーナス毎回分割金-->
<label style='margin-left:110'><script>w1('BNSEACHPARTAMT')</script></label>
<input name='f54' style='width:130' onblur="bnsAMT_check()" value='<%= f80 %>'><br>
<!--分割金適用期間-->
<label><script>w1('AMTAPPLTERM')</script></label>
<input name='f150' style="width:30" value='<%= f150 %>'><br><br>
<!--期日区分-->
<label><script>w1('MATUDTTYP')</script></label>
<select name='f34' table='COMCOMB' key='2920' onchange="changeField()" onpropertychange='changeField5()'></select>
<!--承認期限-->
<label style="margin-left:13"><script>w1('APRLIMT')</script></label>
<input name='f35_1' style='width:40' onblur="repay_change()" value='<%= f57_1 %>'><input name='f35_2' style='width:20' onblur="repay_change()" value='<%= f57_2 %>'><input name='f35_3' style='width:20' onblur="repay_change()" value='<%= f57_3 %>'>
<!--返済月数-->
<label><script>w1('RIMBMNS')</script></label>
<input name='f36' style='width:30' onblur="repay_change()" value='<%= f58 %>'><input type='hidden' name='f37' style='width:80' value='<%= f59 %>'><br>
<!--据置区分-->
<label><script>w1('EXPTYP')</script></label>
<select name='f38' table='COMCOMB' key='890' onchange="changeField3()" onblur='changeField6()'></select>
<!--最終据置日-->
<label style='margin-left:26'><script>w1('EXPEXPR')</script></label>
<input name='f39_1' style='width:40' value='<%= f61_1 %>'><input name='f39_2' style='width:20' value='<%= f61_2 %>'><input name='f39_3' style='width:20' value='<%= f61_3 %>'>
<!--据置月数-->
<label><script>w1('EXPMTHS')</script></label>
<input name='f40' style='width:30' value='<%= f62 %>'><input type='hidden' name='f41' style='width:80' value='<%= f63 %>'><br>
<!--約定日-->
<label><script>w1('THEDATE')</script></label>
<input name='f42' style='width:25' onblur='cal13()' value='<%= f64 %>'><br>
<input name='f43' type='hidden' value='<%= f66 %>'><br><!--振込猶予区分-->
<!--返済資源-->
<label><script>w1('REPAYFUND')</script></label>
<input name='f55' style='width:360' maxlength='20' value='<%= f81 %>'><br>
<!--返済方式-->
<label><script>w1('RIMBMTHD')</script></label>
<input name='f56' style='width:360' maxlength='20' value='<%= f82 %>'><br>
<!--期待効果-->
<label><script>w1('EXPECEFF')</script></label>
<input name='f57' style='width:360' maxlength='20' value='<%= f83 %>'><br>
</p>

<!-- 5th tab -------------------------------------------------------------------------------------->
<p id=tabPages class='TabPage'>

<label><script>w1('RATEKIND')</script></label>
<select name='f8' table='COMCOMB' key='880' onchange="cal6();" onblur='u_devide()'></select><br>

<label><script>w1('CHPCODE')</script></label>
<input name='f9'  qtype="3314" master="glDay" master2="f211" slave="f10"  style="width:30" onpropertychange="changeValue0();changeView4()" value='<%= f31 %>'><input name='f9Lbl' style="width:270" readonly tabindex=-1 value='<%= f9Lbl %>'>
<label style="margin-left:-10"><script>w1('BASERATECODE')</script></label>
<input name='f10' qtype="3305" master="glDay" master2="f9" master3="f211" style="width:30" onpropertychange="localQuery10()" value='<%= f32 %>'><input name='f10Lbl' style="width:270" readonly tabindex=-1 value='<%= f10Lbl %>'><br>

<label><script>w1('CAPSELECTTERM')</script></label>
<input name='f11' style="width:30" qtype="8001" pop='no' f3ESC='Y' master="f211" master2="f9" master3="f10" master4="ichaMonth" master5="glDay" onpropertychange="searchrate1();" value='<%= f33 %>' maxlength="3">
<label style="margin-left:260"><script>w1('FIXRATESPCTYP')</script></label>
<input name='f12' style='width:30' qtype="7001" pop='no' f3ESC='Y' master="f211" master2="f9" master3="f10" master4="ichaMonth" master5="glDay" onpropertychange="searchrate2();" value='<%= f34 %>'><br>

<label><script>w1('NEXTCHPCODE')</script></label>
<input name='f13' style='width:30' qtype="3324" master="glDay" master2="f211" slave="f14" onpropertychange='searchrate3()' value='<%= f35 %>'><input name='f13Lbl' style='width:270' readonly tabindex='-1' value='<%= f451 %>'>
<label style="margin-left:-10"><script>w1('NEXTBASERATECODE')</script></label>
<input name='f14' style='width:30' qtype="3305" master="glDay" master2="f13" master3="f211" onpropertychange='searchrate4()' value='<%= f36 %>'><input name='f14Lbl' style='width:270' readonly tabindex='-1' value='<%= f452 %>'><br>

<label><script>w1('SPECCODE')</script></label>
<input name='f503' style='width:30' qtype="3427" master="f211" onpropertychange='searchrate5()' onblur='changeField7()' maxlength='2' value='<%= f503 %>'><input name='f503Lbl' style='width:270' readonly tabindex='-1' value='<%= f458 %>'>
<label style="margin-left:-10"><script>w1('LIFEINSUAMT5')</script></label>
<input name='f504' style='width:130' value='<%= f504 %>'><br>
...
<!-- prod code -->
<label><script>w1('GRPRATEINFO')</script></label><br>
<label><script>w1('PRIMERATE')</script></label>
<input name='f16'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f38 %>'><!--PRIME RATE-->
<label><script>w1('PLUSRATE')</script></label>
<input name='f18'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f40 %>'><!--An article addition rate-->
<label><script>w1('MINUSRATE')</script></label>
<input name='f19'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();u_pattern2();" value='<%= f41 %>'><!--An article subtraction rate--><br>
<label><script>w1('FSTGRADRATE')</script></label>
<input name='f20'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f42 %>'><!--A first time stage interest rate-->
<label><script>w1('FSTSPREADRATE')</script></label>
<input name='f21'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f43 %>'><!--A first time SPREAD interest rate-->
<label><script>w1('GRPRATE')</script></label>
<input name='f17'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal32();" value='<%= f39 %>'><!--An article rate--><br>
<label><script>w1('CAP')</script></label>
<input name='f22'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal40();" value='<%= f44 %>'><!--A CAP rate-->
<label><script>w1('FLOOR')</script></label>
<input name='f23'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f45 %>'><!--An FLOOR rate-->
<label><script>w1('NEXTSPREADRATE')</script></label>
<input name='f24'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f46 %>'><!--A next SPREAD rate--><br>
<label><script>w1('TERMRATE')</script></label>
<input name='f25'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f47 %>'><!--A period interest rate-->
<label><script>w1('CAPTERMSPREADRATE')</script></label>
<input name='f26'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();" value='<%= f48 %>'><!--CAP period SPREAD-->
<label><script>w1('PRODFIXRATE')</script></label>
<input name='f438' style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal17();"><!--An article fixation rate--><br>
<label><script>w1('CIFCAP')</script></label>
<input name='f441' style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal32()"><!--Customer CAP--><br><br>

<!--fix fee-->
<label><script>w1('FIXRATE')</script></label>
<input name='f27' style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding()"><!--A decision interest rate-->
<label><script>w1('INCRS')</script></label>
<input name='f28' style='width:80' onkeydown="allowFloat()" onKeyup="checkFloat()" onblur="u_autopadding()" onpropertychange="cal32();" value='<%= f50 %>'><!--An addition interest rate-->
<label><script>w1('PDCRS')</script></label>
<input name='f29' style='width:80' onkeydown="allowFloat()" onKeyup="checkFloat()" onblur="u_autopadding()" onpropertychange="cal32()" value='<%= f51 %>'><!--A subtraction interest rate--><br>
<label><script>w1('SUPPRATE')</script></label>
<input name='DEPRATE' style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f111 %>'><!--The interest supplying rate-->
<label><script>w1('GUARRATE')</script></label>
<input name='f401' style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal40();cal32();" value='<%= f401 %>'><!--Guarantee rate-->
<label><script>w1('CORPLIFERATE')</script></label>
<input name='f402' style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding()" value='<%= f402 %>'><!--A group life rate--><br>
<label><script>w1('SPECADDRATE')</script></label>
<input name='f505' style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();cal40();cal32();" value='<%= f505 %>'>
<label><script>w1('DEPRATE')</script></label>
<input name='f30'  style='width:80' readonly tabindex=-1 onkeydown='allowFloat()' onkeyup='checkFloat()' onblur='u_autopadding()' value='<%= f52 %>'><!--Deposit rates-->
<label><script>w1('TRFMAGRATE')</script></label>
<input name='f33'  style='width:80' readonly tabindex=-1 onkeydown='allowFloat()' onkeyup='checkFloat()' onblur='u_autopadding()' value='<%= f55 %>'><!--An interlocking movement addition interest rate--><br>
<label><script>w1('LONRATE')</script></label>
<input name='f506'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();" value='<%= f506 %>'>
<label style="margin-left:208"><script>w1('CURTRATE')</script></label>
<input name='f32'  style='width:80' readonly tabindex=-1 onpropertychange="u_autopadding();" value='<%= f54 %>'><!--An application rate-->
...
<label style="margin-left:17"><script>w1('COALCODE')</script></label>
<input name='f408' qtype='3141' style='width:45' onpropertychange="label4();getDesc()" onblur="u_coalpadding()" value='<%= f408 %>'><input name='f408Lbl' style='width:200' readonly tabindex='-1' value='<%= f408Lbl %>'>
<label><script>w1('INSTNO')</script></label>
<input name='f407' qtype='3142' master='glDay' master2='f408' style='width:45' onblur="u_padding()" onkeyup="clslabel()" value='<%= f407 %>'><input name='f407Lbl' style='width:200' readonly tabindex='-1' value='<%= f407Lbl %>'><br>
<label style='margin-left:17'><script>w1('PRIPATTERN')</script></label>
<input name='f408_1' style='width:45' qtype='80' onpropertychange='u_pattern1()' value='<%= f500 %>'><input name='f408_1Lbl' style='width:200' readonly tabindex='-1' value='<%= f500Lbl %>'><br>
<input name='f407tmp' type='hidden'>
<label style="margin-left:9"><script>w1('PNTPRIVFLAG')</script></label>
<select name='f403' table="COMCOMB" key="4930" onpropertychange='changeValue2();' value='<%= f403 %>'></select>
<label style="margin-left:197"><script>w1('PNTPRIVRATE')</script></label>
<input name='f31' style='width:80' onpropertychange="u_autopadding();changeValue4();" readonly tabindex='-1' value='<%= f53 %>'><br>

<label><script>w1('CHPPRVFLAG')</script></label>
<select name='f404' table="COMCOMB" key="4930" onpropertychange="changeValue3()" value='<%= f404 %>'></select>
<label style="margin-left:197"><script>w1('CHPPRVRATE')</script></label>
<input name='f439' style='width:80' onpropertychange='u_autopadding();changeValue4()' readonly tabindex='-1'><br>

<label style="margin-left:17"><script>w1('MAXPRIVRATE')</script></label>
<input name='f406' style='width:80' onkeydown='allowFloat()' onkeyup='checkFloat()' onblur='u_autopadding();changeValue4();' value='<%= f406 %>'>
<label style="margin-left:167"><script>w1('APLPRIVRATE')</script></label>
<input name='f440' style='width:80' onpropertychange='u_autopadding();cal32()' readonly tabindex='-1'><br><br>

<span style="overflow:auto; width:99%; height:300; border:none">
...
<label style="margin-left:-25"><script>w1('CALAPPLRATE')</script></label>
<input name='f151' style='width:80' onblur='u_autopadding()'>%<br><input name='old151' type='hidden' value='<%= f151 %>'>

<span style="overflow:auto; width:99%; height:400; border:none">
...
<% for (int i=0; i<60; i++) { %>
	<tr bgcolor=white align='center'>
        ...
        <td id="td154"><input name='f154' class=xInput style='width:170;text-align:right' value='<%= (i < nLoop8) ? f154[i]:"" %>' onkeydown='allowNumber()' onkeyup='fCurrency2()' onblur='u_compare2()' onFocus='u_focus()' iLen=15 fLen=0 mask='02'></td>
	</tr>
<%  } %>
</table>
</span><br>
...
<!-- 事務取扱手数料 -->
<label style='margin-left:20'><script>w1('OFFICETXFEE')</script></label>
<input name='f601' style='width:150;text-align:right' onpropertychange='u_moveValue()' onblur="u_autoPadding()" value='<%= f601 %>'><br>  <!--  20160331---------->
<!-- 印紙代 -->
<label style='margin-left:20'><script>w1('STAMPTAX')</script></label>
<input name='f602' style='width:150;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()"  value='<%= f602 %>'><br>  <!--  20160331---------->
<!-- 公証費用 -->
<label style='margin-left:20'><script>w1('KJFEE')</script></label>
<input name='f603' style='width:150;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()" value='<%= f603 %>'><br>  <!--  20160331---------->
<!-- 火災保険料 -->
<label style='margin-left:20'><script>w1('INSUFEE')</script></label>
<input name='f604' style='width:150;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()" value='<%= f604 %>'><br>  <!--  20160331---------->
<!-- 担保調査費用 -->
<label style='margin-left:20'><script>w1('OUTCOLLRESFEE')</script></label>
<input name='f605' style='width:150;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()" value='<%= f605 %>'><br>   <!--  20160331---------->
<!-- 確定日付料 -->
<label style='margin-left:20'><script>w1('FIXDATEFEE')</script></label>
<input name='f606' style='width:150;text-align:right' onpropertychange='u_moveValue()'  onblur="u_autoPadding()" value='<%= f606 %>'><br>    <!--  20160331---------->
<!-- 登記費用 -->
<label style='margin-left:20'><script>w1('DKFEE')</script></label>
<input name='f607' style='width:150;text-align:right' onpropertychange='u_moveValue()'   onblur="u_autoPadding()" value='<%= f607 %>'><br>    <!--  20160331---------->
<!-- 差引後顧客口座入金金額 -->
<label style='margin-left:3'><script>w1('NETDEPTOTAMT')</script></label>
<input name='f608' style='width:150;text-align:right' readonly tabindex='-1' >   <!--  20160331---------->

</p>

<iframe name=popup width=0 height=0>
</iframe>
<iframe name=popup2 width=0 height=0>
</iframe>
<iframe name=popup3 width=0 height=0>
</iframe>
<iframe name=popup4 width=0 height=0>
</iframe>
<iframe name=popup6 width=0 height=0>
</iframe>
<iframe name=popup7 width=0 height=0>
</iframe>
<iframe name=popup10 width=0 height=0>
</iframe>
<iframe name=popup8 width=0 height=0>
</iframe>
<iframe name=popup9 width=0 height=0>
</iframe>
<iframe name=popup11 width=0 height=0>
</iframe>
<iframe name=popup12 width=0 height=0>
</iframe>
<iframe name=popup13 width=0 height=0>
</iframe>
<iframe name=popup15 width=0 height=0>
</iframe>
<iframe name=popup16 width=0 height=0>
</iframe>
<iframe name=popup17 width=0 height=0>
</iframe>
<iframe name=popup18 width=0 height=0>
</iframe>
<iframe name=popup19 width=0 height=0>
</iframe>
<iframe name=popup20 width=0 height=0>
</iframe>