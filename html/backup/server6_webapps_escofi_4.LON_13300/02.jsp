...
<input type='hidden' name='f1_1' value='<%= f4_1 %>'><input name='f1_2' style='width:40px;' readonly tabindex='-1' value='<%= f4_2 %>'><input name='f1_3' style='width:40px;' readonly tabindex='-1' value='<%= f4_3 %>'><input name='f1_4' style='width:20px;' readonly tabindex='-1' value='<%= f4_4 %>'><input name='f1_5' style='width:60px;' readonly tabindex='-1' value='<%= f4_5 %>'>
<label class="tab_page_label"><script>w1('CURRENCYCD')</script></label> <input name='f100'  style='width:40px;' readonly ></input><br> <!--20160321fx add ---->
<input type='hidden' name='h1_1' value='<%= f4_1 %>'><input type='hidden' name='h1_2' value='<%= f4_2 %>'><input type='hidden' name='h1_3' style='width:40px;' value='<%= f4_3 %>'><input type='hidden' name='h1_4' style='width:20px;' value='<%= f4_4 %>'><input type='hidden' name='h1_5' style='width:60px;' value='<%= f4_5 %>'>
<label class="tab_page_label"><script>w1('CIF')</script></label>
<input type='hidden' name='CIF_1' readonly tabindex=-1 value='<%= f9_1 %>'><input type='hidden' name='CIF_2' style='width:40px;' readonly tabindex=-1 value='<%= f9_2 %>'><input name='CIF_3' style='width:80px;' readonly tabindex=-1 value='<%= f9_3 %>'><input name='CIFNAME' style='width:600px;' readonly tabindex=-1 value='<%= f10 %>'><br>
...
<input name='f220' style='width:40px;' onpropertychange="u_getGuarKind(this.value)" readonly tabindex=-1 value='<%= f19 %>'><input name='f220Lbl' style='width:240px;' readonly tabindex='-1'><br>
...
<input type='hidden' name='f222_1' readonly tabindex=-1 value='<%= f21_1 %>'><input type='hidden' name='f222_2' readonly tabindex=-1 value='<%= f21_2 %>'><input name='f222_3' style='width:40px;' readonly tabindex=-1 value='<%= f21_3 %>'><input name='f222_4' style='width:25px;' readonly tabindex=-1 value='<%= f21_4 %>'><input name='f222_5' style='width:60px;' readonly tabindex=-1 value='<%= f21_5 %>'><br>

<label class="tab_page_label"><script>w1('GUARCOKINDCODE')</script></label>
<input name='f296' style='width:40px;' qtype='3206' onpropertychange="getDesc()" readonly tabindex=-1 pop='no' value='<%= f96 %>'><input name='f296Lbl' style='width:250px;' readonly tabindex='-1' value='<%= f296Lbl %>'>
<label class="tab_page_label"><script>w1('GUARCOMPCODE')</script></label>
<input name='f297' style='width:40px;' qtype='3207' onpropertychange="getDesc()" readonly tabindex=-1 pop='no' value='<%= f97 %>'><input name='f297Lbl' style='width:240px;' readonly tabindex='-1' value='<%= f297Lbl %>'><br>
