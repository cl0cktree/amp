...
<script>var trInXml = loadXML('/codeXml/4.LON/13300_01in.xml')</script>
<script>var trOutXml = loadXML('/codeXml/4.LON/13300_01out.xml')</script>
<script>
	function initPage() {
		setMsg("");
...
<button id=NEW onclick="top.execute(document.all.trCode.value, '01')" style='border:1px inset;'><sup>F5</sup>&nbsp;<script>w1('APPLICATION')</script></button>
<button id=DELETE onclick="top.execute(document.all.trCode.value, '03')"><sup>F7</sup>&nbsp;<script>w1('DELETE')</script></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
<input type='hidden' name='f1_1'><input name='f1_2' style='width:40'><input name='f1_3' style='width:40'><input name='f1_4' style='width:20'><input name='f1_5' style='width:60'><br>
<!--<label><script>w1('APPRTYPE')</script></label> -->
