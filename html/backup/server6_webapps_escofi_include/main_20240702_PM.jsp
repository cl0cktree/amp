				...
				<table cellspacing=0>
					...
					<tr>
						<td id=leftScreen height=5 bgcolor=#00aeef>
							...
							<!-- 20240617  style ? ?? px ?? ?? -->						
							<input name="trCode" id="screenNumber" tabindex="-1" readonly="true" maxlength="5" type="number" style="width:54px; border: solid 1px black;" onkeypress="trCode_keypress()" placeholder="trcode">
							<!-- 20240617 ??? style ? ?? px ?? ?? //-->	
